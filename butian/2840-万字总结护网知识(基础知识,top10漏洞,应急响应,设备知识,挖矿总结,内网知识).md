...
> **来源**: https://forum.butian.net/share/2840  
> **文章ID**: 2840
...
- 若程序使用Maven打包，查看项目的pom.xml文件中是否存在下图所示的相关字段，若版本号为小于2.15.0-rc2，则存在该漏洞。  
    ![](images/attach-b2918c4bfc1c5fd9d14047825cdeea852a054b0d.jpeg)
...
- 再利用另一个脚本:  
    ...
    ![img](images/attach-60ef83487aee53c90d3fefb2e582cd536c0596ec.jpeg)
- 运行后会在后台不断爆破，payload越长所需爆破时间就越长  
    ![img](images/attach-274b34912c117eb910ac0f60b3f815a1d69407ef.jpeg)
- 将爆破的结果复制替换之前的cookie  
    ![img](images/attach-afa432235173145014da426165c0d886c9841cf3.jpeg)
...
![OSI七层模型](images/attach-c2f8442ddb1b8a044ca1607ef09030ce804b4e3c.jpeg)
