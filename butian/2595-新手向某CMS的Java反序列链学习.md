...
> **来源**: https://forum.butian.net/share/2595  
> **文章ID**: 2595
...
![image-20231121165101578](images/f186754118a68de57ddea6087983cff7326de600aa78a.jpg)

跟进系统代码发现在后续获取redis存储数据过程中需要进行反序列化操作（触发点），这里通过`jedis#get`方法获取key的value值，然后交给`valueSerializer#deserialize`方法进行反序列化处理：

![image-20231106171213003](images/f140192f0f9e986505756331d265553d63a1979d063ca.jpg)

我们跟进该方法，可以发现将获取的字节数组转换为对象流，然后调用了`readObject()`方法完成反序列化操作：

![image-20231106171251505](images/f888379e63e84795e1f235371645d43ea4ec72b1a516a.jpg)

我们将编写的Java反序列化链写入redis数据库，通过访问网站成功触发反序列化漏洞：

![image-20231120094317104](images/f258505f983a19257924866f4dbcd49b02947a01de0ae.jpg)
...
![image-20231115095416600](images/f3535968f1c52b2a8b1b05ce3beaa33bd02b95e6575de.jpg)
...
![image-20231109152457724](images/f334101356cea8197739ac7d03f43fb8fa5c15bf05c6e.jpg)
...
![image-20231109163536969](images/f7903960721ec509abc55a0fcfa58ace646efac4893f3.jpg)
...
![image-20231109154440296](images/f32446381103a63ad7ed757b89a70f7fc87abce0796f6.jpg)
...
![image-20231109165415125](images/f98344923fe78ae4396273cd368c7b211bc589e365b65.jpg)
...
![image-20231109170125568](images/f94820174fdc64d610b0a17c686f86c6ca22f210122d1.jpg)
