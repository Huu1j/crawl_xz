...
> **来源**: https://forum.butian.net/share/3058  
> **文章ID**: 3058
...
![image-20240516213314292](images/attach-b9ff21fd3f3511037aeeb1542c0ddb8fa858092e.png)

![image-20240516213337274](images/attach-c8a5fe1e6e3600a4e2dd1c65eab8802edb198c85.png)

选择模块然后点击安装，建议选择全模块安装，这样功能多，漏洞也多

![image-20240516213402743](images/attach-c570980e1ab72241b155240be8a4c18431851c08.png)

等待安装完成

![image-20240516213431139](images/attach-69550d82d5cd94175b2a0e83519784509ea9be34.png)

安装完成后目录（一般默认安装在C:\\），运行startServer.bat 启动服务

![image-20240516213528031](images/attach-d63d1a38431336e432afd30433d6ff975eef50be.png)

![image-20240516213608016](images/attach-5ccc430691854f7c234038475d0785c2abbcb6ce.png)
...
![image-20240516214848514](images/attach-8e7e549ae914dffae30b5241bbfd12d491b0b54b.png)
...
![image-20240516215511117](images/attach-0a1670e8d552effea1010ae038de6abfe79eeb81.png)

IDEA配置

![image-20240516214819885](images/attach-e08ddd9685286d315e278129542adcecd2f145c0.png)

在jar中class文件下断点

![image-20240516220046757](images/attach-fdc4b8e0e0287e71482e56675095d6f3ee0ffff1.png)

![image-20240516220105442](images/attach-5c26c0be75acb1023b2afa6a857cf32fc52b6dc6.png)

![image-20240516220935169](images/attach-f07f862977dd12bc9e1cfe6474ab97395e8d5e61.png)
...
![image-20240516221033074](images/attach-742ccb0054d7915e727b688c5a45e28293772305.png)

将1.bat和cfr.jar放在一个目录，运行就批量反编译

![image-20240516221132903](images/attach-cc56f23e105b1fd04daf6c6662484e9d86ed4ee2.png)
...
![image-20240516221424319](images/attach-a7dea8d07fbb0ec1327e880afc8e7be13dbd47e5.png)
...
![image-20240516222116969](images/attach-8fa7aa623a056fb24b277f5f82d7422fd414ffb9.png)

在`WorkflowService`类中，将`proDefPk`参数传入`getWfmXmlByPk`方法

跟进getWfmXmlByPk方法

![image-20240516222146091](images/attach-968d346356fbe733fb47d7d1eaeae08441e4768d.png)

看到使用到了 `getProDefVOByProDefPk`带入pk参数

![image-20240516222205142](images/attach-e513415dd4d7dbadeb2c084c6454d56fd8d988d7.png)

`getProDefVOByProDefPk` 是 接口类`IWfmProDefQry`定义的方法

在`WfmProDefQry`类实现`getProDefVOByProDefPk`方法

![image-20240516222222456](images/attach-ad45419e0455c08580be24bbc5cf46941c19757e.png)
...
![image.png](images/attach-627d8229b623a62b4a3ae71002a96dc1cd7344ee.png)

![image.png](images/attach-3b3c99fddfbd7d6f1a1193c104cfceb2580abfb7.png)

`strWhere = (isnull(dr,0)=0) and pk_prodef='11';waitfor delay '0:0:4'--'`  
可以看到 sql语句 查询pk\_prodef字段是使用`'`闭合了sql，导致注入漏洞

![image-20240516222313463](images/attach-c2ea0030ad74d65970676258558b56d5ff5aadbf.png)
...
![image-20240516222539420](images/attach-548a5fec2ef2442631417f5589b9c34b9987ad02.png)
...
![image-20240516222720074](images/attach-879e362683b7387697d22a0eb2cae59d6324b5d9.png)
...
![image-20240516222848172](images/attach-01a16b4904d97d9ad99dfa74684180aa212a34c1.png)

提交了三个漏洞，重复了一个，两个高危

![image-20240516222942430](images/attach-eab5c14b517f0c9933b9011e39e025116c7e01b4.png)

![image-20240522190609516](images/attach-d9faa3a9bcd3461f34c5bac1f0d47e7887526b91.png)
