...
> **来源**: https://forum.butian.net/share/3007  
> **文章ID**: 3007
...
![图片.png](images/attach-31e65fabd63c36943186e61b8cd592f61a38250e.png)
...
![图片.png](images/attach-ff5bd4c85172cc621f2cf80dcb2f7efc21929e7e.png)
...
![图片.png](images/attach-249275942d3ab93fe4484a29b0678bc313d87458.png)
...
![图片.png](images/attach-e2680221ccfb0f09d1e055dadd093b2c98bac9cd.png)
...
![图片.png](images/attach-a8174e59e8ade8f4dca10d826a6181daaff99bfe.png)

查看源代码：

![图片.png](images/attach-91d6071b346ca0cb372b6d79b79a66847f28b676.png)
...
![图片.png](images/attach-85f71b01da15bb5199904bc0015e826fe589e7f8.png)
...
![图片.png](images/attach-62a0b4877445b8104c19c7104afdcf1e03e8d242.png)
...
![图片.png](images/attach-08b434c44670c2b26d570add08ec6fa262f25e0f.png)
...
![图片.png](images/attach-30de38b3350b1a1a25c800b380534da07ff68659.png)

访问1.php,查看一下本地session文件，发现payload已经存入到session文件

![图片.png](images/attach-c7ba4a75c56064f16f538adc81581b0c6dcafac3.png)

php\_serialize引擎传入的payload作为lemon对应值，而php则完全不一样：

![图片.png](images/attach-9ea4fc3715fc7d27d330a5045f1b7cca4d39de4e.png)

访问一下2.php看看会有什么结果

![图片.png](images/attach-92724c49e49b5530469270bf45a67505cff6f1eb.png)
...
![图片.png](images/attach-c883077e526b1a806c4fef00026f787bd4d38598.png)
...
![图片.png](images/attach-a82988940d4a6f9ac06881ff9f811bbb1935091c.png)

当我们随便传入一个值时，便会触发\_\_construct()魔法函数，从而出现phpinfo页面，在phpinfo页面发现

![图片.png](images/attach-7396930f35f4c2da0ab757ac7ab8cdec74385683.png)
...
![图片.png](images/attach-9b26214ea64d1972758b9302fc36aeb33a65c83e.png)
...
![图片.png](images/attach-e840440de7e2b36c1eaa52bf6e41964f58291c6b.png)

可以看到Here\_1s\_7he\_fl4g\_buT\_You\_Cannot\_see.php这个文件，flag肯定在里面，但还有一个问题就是不知道这个路径，路径的问题就需要回到phpinfo页面去查看

![图片.png](images/attach-5d82f9025f8b43eee600ff234d4018b6aa4bfb58.png)
