...
> **来源**: https://forum.butian.net/share/2770  
> **文章ID**: 2770
...
![img00.png](images/attach-2a105e41586733e384c99dcca1058dc23568ca2b.png)

此时，内存中的数据如图：  
![img01.png](images/attach-ec8cc4cf68b56c1d521cb5d2da1a3127ec448986.png)
...
![img02.png](images/attach-e0b1e7088c4ad5cc08dfe3fe44f2acda12e658ea.png)

![img03.png](images/attach-d7c7d37bf1c0866f212ff94808404ffc2e04a4da.png)  
...
![img04.png](images/attach-0fbd911a4d37a07cd85738f482844753dd6887f4.png)

在这个地图片段的最下方，有一个像是L的地方。如果用算法的话，它总是会这样前进：

![img05.png](images/attach-f8e07d998a7200d72a008dcdbe64cbd76a846937.png)

然而，根据一般逆向题的逻辑，这里的路径应该是要长成这个样：

![img06.png](images/attach-3a56f3cd4a523487de6589a4be90dc2b42b14c8c.png)
