...
> **来源**: https://forum.butian.net/share/2480  
> **文章ID**: 2480
...
![image.png](images/attach-bff88e1e3c651da0c8a35ef425be32b587ba2807.png)
...
![image.png](images/attach-a6a5bf636c5866b3f9d0e6c880567069293a0eed.png)
...
![image.png](images/attach-268419331afa1cfdf29012e79afd297f4b708f8c.png)

 可以看到该组件依赖在内部使用JNI来与libwebp进行交互：

![image.png](images/attach-72ac4646a133c6be0143ef97891c938820d9344c.png)
...
![image.png](images/attach-9e81c1143b7ac6af791c61fe4da1b0f3d50512ce.png)
...
![image.png](images/attach-8a6e20ce60085625e7bfdbaae0a435e4f6224af6.png)
...
![image.png](images/attach-1319911970f7e7d908115fa2f8c5b9b04727bf2c.png)
...
![image.png](images/attach-bb9885218bf99ca29cea345b164dee91a34d1443.png)

 项目中包含pom文件：

![image.png](images/attach-5ea9c6fa9c54893b5bb820274398a88f869ab568.png)

 根据其groupId和artifactId（org.sejda.imageio:webp-imageio）查询可知其是一个Java的依赖组件：

![image.png](images/attach-fe6b60fc92b38ff762b6fed251c4bb5ffff9cf1f.png)
...
![image.png](images/attach-f00ee35d02ea2fc279c22b7113be2726a90cd15b.png)
...
![image.png](images/attach-c6563ec198c1045cb4cc1315d979ea5989ca3b8e.png)

 例如python的achimoraites/Python-Image-Converter进行了对应的漏洞修复，这里也可以结合`language:Java`关键字筛选出Java相关修复了libwebp漏洞的组件：

![image.png](images/attach-9663f3eab7ad95f66b04497fc1aa1bcd41e19361.png)
