...
> **来源**: https://forum.butian.net/share/2614  
> **文章ID**: 2614
...
![image-20231115163025371](images/f623597f2259043f7e8da211c8e6447e109bc93dd346e.jpg)
...
![image-20231115164404418](images/f406053d8daec55e7f4339ccc356f6b394a36b491b5c2.jpg)

创建类对象时会调用父类`mainAction`的`__construct`方法来初始化

![image-20231115165140510](images/f8335527ca22b635b9d0f618ea030ad20d14cd40484d5.jpg)
...
![image-20231116154704599](images/f3894929d3c51cba6903489e09f9cc506eeef94fc72f4.jpg)
...
![image-20231116155454062](images/f243108f63ff436287b07f08d1264eacc7d4e794249bc.jpg)
...
![image-20231116160641627](images/f3009047c4b0c2f91e3b3b2049c39f85507c091db8d77.jpg)

发现延迟并没有生效，并且提示`openkey not access`。咦~，哪里有问题呢

搜索`openkey not access`，原来是该类的父类中的`initAction()`做了判断

![image-20231116160937096](images/f449607da9a8446b82b24c4d75f52b6e2829173d55980.jpg)

这里需要进行一个openkey的校验，看到24行的if判断，如果HOST为127.0.0.1或者包含”192.168”的话就会跳过这个校验，此处的HOST就是$\_SERVER\['HTTP\_HOST'\]，也是我们可控的

![image-20231116161135943](images/f55984320a760db02a9e4327e78e13e89d5dff2de0f81.jpg)
...
![image-20231117162312439](images/f707872eb71ce957d4a30f695ed2846ea3a40d51b04f1.jpg)
...
![image-20231117162726595](images/f327709326414ff56e72bc01c25242c2dac184a141f0b.jpg)
...
![image-20231117163139090](images/f443485d4601f7f8742b67f5e3f65a68d8093c036eaff.jpg)
...
![image-20231117163553609](images/f908168ef23cfd817d45ca3e076677d2febecc1711159.jpg)
...
![image-20231117174024766](images/f3106635ee21fd8bd98f90d88e356f3b91dc310d47aad.jpg)
