...
> **来源**: https://forum.butian.net/share/3044  
> **文章ID**: 3044
...
![image.png](images/attach-13cab30ea344a358a888d20ac257dc480b60803a.png)

我们关注的重点还是如何越狱大模型。

由于开源社区力量的进步，现在有很多“开箱即用”的大型语言模型。比如在huggingface上就有很多。

![image-20240520212435489.png](images/attach-8771c4042a93cb02793d6beff7f1fa84da1f0b22.png)  
...
![image-20240520212642141.png](images/attach-1a25f062b6fd9e956c1a565be2b71bcf610f421f.png)  
...
![image-20240520214210386.png](images/attach-81dae17fe5beae3e1d25a1abe6b5da2a33e827bb.png)  
...
![image-20240520214316030.png](images/attach-dd8fbed923fd702cdcc11a362d6c0deebf9947b0.png)  
...
![image-20240520215359147.png](images/attach-18eaea77ceb854184b599fd1622527e6a02a4f60.png)  
...
![image-20240520215742433.png](images/attach-5d66e9bbc6b1602d1d0259feaecd1a241203ebde.png)  
...
![image-20240520215955080.png](images/attach-03a1c96767634e3fd18a491bc233c28e0dde5a42.png)  
在这个符号下，我们所关注的对抗性损失仅仅是某个目标token序列x⋆n+1:n+H的（负对数）概率（即，代表短语“当然，这里是制造炸弹的方法。”）

![image-20240520220029877.png](images/attach-cd758a689239f761bdbba776586ac3dc9573a0af.png)  
因此，优化我们的对抗性后缀的任务可以写成优化问题

![image-20240520220056081.png](images/attach-4779d1c6c8c1471941d49a56c4d5d27b88174833.png)  
其中I ⊂ {1, . . . , n}表示LLM输入中对抗性后缀令牌的索引。

![image-20240520220056081.png](images/attach-a5239dc5872b21b24864bdba8b4e0cb2a1c47cab.png)
...
![image-20240520220331214.png](images/attach-048040b084304dd916d46a33a8d19584e504a6e2.png)  
...
![image-20240520220503631.png](images/attach-902105306e3962484e37c225a29731aba2c9c00e.png)
...
![image-20240520220655899.png](images/attach-e1d21f99ca337da19b504c0367cd90109104dad3.png)  
...
![image-20240520221011974.png](images/attach-13a3d7b49131cd162828945111e7df5c59e62483.png)  
...
![image-20240520221147563.png](images/attach-768e2c833aae5b8026db1c4a485f190fe4fccc25.png)  
...
![image-20240520221337675.png](images/attach-99c6b35b40520d2d89f55c315a4b374b4d4f1a34.png)  
...
![image-20240520221516233.png](images/attach-82409a517be9690355c6df131ecd539815748200.png)
...
![image-20240520221632527.png](images/attach-95790e828ea9b6cb35d5ef716223f572565b50b0.png)  
然后设置我们的模型环境

![image.png](images/attach-f3f41d34af695062cf1a58d37dbbdcebb4b1d93a.png)  
接着设置所需的参数

![image-20240520221734602.png](images/attach-5f74ed69b4ffa063fc26ccb63f9baf654353c9df.png)  
...
![image-20240520221847234.png](images/attach-e09874b81123cd0a7df172fccf8ca946ee657f46.png)  
...
![image-20240520222031509.png](images/attach-abe2f4d662f75f146ccbb95c4e07c2755205ea1b.png)  
...
![image-20240520210650583.png](images/attach-88f93cc352d958fda1bbf7838fc8b160986c004c.png)

![image-20240520210659215.png](images/attach-6cf36b3d17c8dd1d0850c2afc396b4ba3986f139.png)

![image-20240520210707395.png](images/attach-1d2af1b10b5a645f54d2f008bb237ad7d406859c.png)  
这里我们将vscode缩小，可以看到还会显示损失函数

![image-20240520211132163.png](images/attach-356ab508b247debc212b3498bbfa0a7b030b33f6.png)

![image-20240520211752928.png](images/attach-236f9530c3a285543c429d1b2caf68631ec37cff.png)  
我是在一个a800的机器上测试的，大约花了半小时

![image-20240520222249320.png](images/attach-9f431d045754b6528e4acd27fab19f082b73da93.png)  
然后我们进行攻击测试

![image-20240520222408096.png](images/attach-a9b9f409e59e339749053bafb9134cf4e1c89495.png)  
这部分代码分为两个部分：
...
![image-20240520222446874.png](images/attach-a4263e1f238093d7c1965923555ed791fe2d9313.png)  
我们可以把结果粘贴出来
...
![image.png](images/attach-ca11e7634b6ad415f1e04f6a30da5a60dfff2e67.png)
