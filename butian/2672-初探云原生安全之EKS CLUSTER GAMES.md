...
> **来源**: https://forum.butian.net/share/2672  
> **文章ID**: 2672

---

![image.png](images/attach-a6bd8e5201d9b3acabab76783d165415fd03162a.png)  
yysy这个界面还是蛮好看的
...
![image.png](images/attach-a37707b54827ef1a857b09296e1f2bd928b1d6c3.png)  
...
![image.png](images/attach-98ff1b5bf5f019adbfe92ecda96118c520f1255a.png)

*kubectl get secrets -o yaml*  
这样也可以  
![image.png](images/attach-00772ae5fda5b49010ebe2f2d0106d715b7a4507.png)
...
![image.png](images/attach-6501d11faf32e1b7c7c912b76a28a229a6ed9d9f.png)  
这关没法直接list secrets  
尝试 kubectl get secrets -o yaml  
forbidden  
![image.png](images/attach-a6244b0bc19ac1cb562dbc9a55fc616b526ca648.png)
...
![image.png](images/attach-cb0a28c5c41d678a4fcc9783a2e6b2572552bb82.png)

kubectl get secrets registry-pull-secrets-780bab1d -o yaml  
![image.png](images/attach-21674aa58e47b23d7942ce40ab2979abf5d514b1.png)  
拿到dockerconfigjson  
![image.png](images/attach-b3b4ba9af8a303dec4e07b51ccaac9d916a38068.png)  
auth字段拿出来再base64解码  
![image.png](images/attach-8bb31c5c7547c34b76364684d025e609a96b2166.png)
...
![image.png](images/attach-aaa2f80a9b6140235d60b787e21819c5aa68ae7f.png)  
读config 拿到flag  
...
记住：你在被入侵的 EKS pod 中。  
![image.png](images/attach-fa7966f9842aab802792582d8dd532f0a4a0f597.png)  
先看看  
kubectl get pods -o yaml  
![image.png](images/attach-d53bd810e681ff69e7b1f6e58ba882c48b735974.png)  
...
![image.png](images/attach-12f14b624de23a044ca6c17d259866899c260022.png)
...
![image.png](images/attach-81e284cc4f84fcd4e88d3aaeea0c27f713258c78.png)  
看到了  
ARN（Amazon Resource Name）  
`arn:partition:service:region:account-id:resource`  
去拿eks的token  
aws eks get-token --cluster-name eks-challenge-cluster  
![image.png](images/attach-9ac8e75b1a0c29e830b4051a7a4ec3151ae52eb2.png)  
kubectl get secrets -o yaml --token=""  
填入值  
![image.png](images/attach-9e068e221582fce35a5a25de989900287f6b717b.png)  
拿到flag
...
![image.png](images/attach-3776e58631c65235ba6d2a83daf7700540762e55.png)  
从IAM POLICY中 我们可以知道flag在s3存储桶里  
![image.png](images/attach-70dc8cc6f3d9019a16e6e2275040d498a289e9a3.png)  
Trust POLICY中 给到了一个oidc服务  
![image.png](images/attach-7cd8a3424a974736c694507269807d4c76db21d7.png)  
...
![image.png](images/attach-38841fad995bdf3cf75b601e7cb3b5bb6f2d3fe4.png)
...
- `--web-identity-token`：OIDC 令牌，用于证明身份验证的有效性。  
    ![image.png](images/attach-9cab5adec33a230e09fe2c87975acf8e8e54ac41.png)  
    取到以后就可以去美滋滋的登录了 ```php
...
![image.png](images/attach-b119efccbc868f0b1c8f41b40a083f9c5b39871d.png)
复制flag到标准输出然后读 

完结撒花
![Qzufb5A5.png](images/attach-d232a5b8a1b9b0a15cb8962769e2c6263b4be4a3.png)
```
