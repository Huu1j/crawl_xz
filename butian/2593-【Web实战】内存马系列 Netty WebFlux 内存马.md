...
> **来源**: https://forum.butian.net/share/2593  
> **文章ID**: 2593
...
![image.png](images/attach-ffd9a86ebf0c1c7a40601f61aeae0d81d814d3b4.png)
...
![image.png](images/attach-bec1e9bbcacfe814a7cc094f7922b8f2ee87ed59.png)  
我们可以尝试如下获取
...
![image.png](images/attach-f12b23ed30235ebd3ba44579f08a6f4f00804dd4.png)  
获取到了config对象，他实际上是一个reactor.netty.transport.TransportConfig类。然后从父类获取doOnChannelInit属性即可。

![image.png](images/attach-512b0bbf0f0b62b707ac85dd8ab461228aba50e6.png)  
最后可以造出如下的内存马
...
![image.png](images/attach-cf6cff136d519d842a5da0b83ab85826b56640af.png)  
在initChannel方法进行初始化时，将我们上面恶意注入的configurer注入进去了

![image.png](images/attach-29baefc5bd015ac3ddaf0f0c40059204f299ec04.png)  
最后合二为一，将NettyMemshell的索引放到首位，也就造成了命令执行

![image.png](images/attach-a23bc4038d83264c181698d012a7fd2c1b311019.png)  
...
![image.png](images/attach-a0b66ef5a3b795490cbec8d778082b6e2e44c99b.png)  
首先会接收到一个DefaultHttpRequest对象，这个对象内部储存了请求头和请求类型等数据。

![image.png](images/attach-146d7f63f4b77dbad3eaa6bf6e39890c0ba17675.png)  
然后处理完header后就是body

![image.png](images/attach-cc378b5beb6e438af0a7e1671536667196762d81.png)  
...
![image.png](images/attach-bcc8c0c40e5da129b729540c35cd2406afffdf21.png)  
...
![image.png](images/attach-604f74cc69cd6c9f699811fd357af63d3ddac85e.png)

![image.png](images/attach-3d07a13085eed2577b34a231fd9fbf1287fbdc2d.png)  
