...
> **来源**: https://forum.butian.net/share/2747  
> **文章ID**: 2747
...
![](images/1706067385517-86dcffd7-c755-49fd-8ed2-471a5ea95133.png)
...
![](images/1693065836274-0658e561-eea2-41ca-a58a-c6cc83e201ac.png)

![](images/1706067398912-0cfb7c46-7704-484f-8a79-121372d0dc6a.png)

默认口令 myname/password 进入后台，可看到版本号

![](images/1706067466988-a90eb1b5-830f-4c1d-b721-e49b4f973270.png)
...
![](images/1706067249406-d037a91b-f8c6-444d-973a-851e09b217c7.png)
...
![](images/1706068225000-672e3c12-e17f-4b9b-a206-ff8d41b62480.png)
...
![](images/1695985424649-93dd0827-53e6-45cd-b3fb-d12644689983.png)
...
![](images/1706067562384-4531b655-6011-4ef8-b983-0877657ea47c.png)

随后即可发现网站对该 zip 进行了下载和解压，这里可以预览 txt 格式文件获取 zippath 参 数的值

3、everything确定shell位置-然后 ashx 文件的地址即为:

![](images/1695994987607-9168db45-a8eb-483a-b3b8-9f254af30b7a.png)

4、resx也可以创建目录使用-直接压缩包里的`App_LocalResources`这个`全局资源目录`也可以在压缩包里创建访问

![](images/1695995470959-83defba3-e3f6-428d-9a15-a6ced411e7e6.png)
...
![](images/1695996632724-58335d11-01c6-4f80-a9a8-26a7f90e14fe.png)

cache/excel

<http://localhost:8088/cache/excel/123.txt>

![](images/1695996626399-8fcf5612-b57a-4cdc-b3e4-71c65688373d.png)

### 0.3、代码分析-压缩包的解压流程-和目录的生成流程原理看看能不能自解压到除了`cache/office`的其他目录比如`cache/excel`、`cache/word`、`cache/ppt`

路由--DefaultController

![](images/1693419376610-6e2c8efa-0d52-4355-ba37-0622b83b8828.png)

furl就有软件过期判断--和邮箱给的key有关`TRIALVER.regkey`

![](images/1695997502776-56cd6e31-b464-4044-9833-1ef131ccbbd3.png)

抓包断点

<http://localhost:8088/?furl=http://10.10.11.1:88/zip.zip>

![](images/1695997554674-a4ea4660-e3e1-4c59-a6b1-bedb0b73d41f.png)
...
![](images/1695998116386-0cad772e-49fb-4af9-9deb-bab4e4b29875.png)

![](images/1695998190689-01bbfc84-a7dd-46b5-a3fc-3d808f5dfc7b.png)

lang.json--用于判断文件有没有问题

![](images/1695998202065-f970be1d-48b0-4287-8bcc-a412956a5573.png)

取消优化到`downFileInfo`

![](images/1695998659361-230b1d89-082b-4950-85eb-03023f2024f5.png)

shell到路径拼接

![](images/1695999000677-35e7a6d9-4e23-4cfb-898c-97b91712e438.png)
...
![](images/1695998958825-ae91ff12-dad1-4452-b904-b175566188af.png)

text5拼接完成zip的包路径

![](images/1695999288121-7ddb7c05-dabc-4b21-a9b9-b70040d91a73.png)
...
![](images/1695999108848-9cc3aabc-eca5-4e76-9b90-039817e759a4.png)
...
![](images/1696001212982-419c6b9b-3857-4727-9278-5b8ee1a4199e.png)

![](images/1696000151746-435261d3-6b00-4e64-9aa1-a39934fb43e4.png)

![](images/1695999041633-af33609b-eb06-4f18-8113-20f6337255e0.png)

回溯应该是在pdfcontroller

![](images/1696001332788-03a4fa50-bae9-4bf3-8739-aa8834977137.png)

2、参数

参数下载地方

![](images/1693419515377-dfe72e57-4c84-4c6d-8fd6-e5142e9e27e8.png)
...
![](images/1706068176137-a935f76e-cec6-4b09-9e84-da3bee2c07aa.png)

### 0.1、遇到的问题

dnspy--C#交互容易抛出异常

![](images/1695793356742-6f4c6bba-c704-4eae-a8e6-10511e99fe6e.png)

重新用本机的反混淆后的dll去C#交互也是一堆异常

![](images/1706067804403-cb1a7e55-ce37-478c-819e-e725c9c642a8.png)

vistudio写的也会，无论是混淆了的dll，还是解开混淆后的dll

![](images/1706067825967-f87e62a0-7957-4450-a598-ca3c6825a848.png)

![](images/1695793418073-ea8ef180-2559-4b36-a526-95335e123371.png)
...
![](images/1706067865134-77984b98-54cf-4fa0-ae61-683aad467e6b.png)
...
![](images/1695804961597-3c89facb-0b0d-4e27-9c40-22328ff0715b.png)

![](images/1695805586537-a9c26c02-fd63-4e1c-9415-a06677a7988f.png)
...
![](images/1695806348875-6dc67eed-1571-4f64-83cc-32a0d918faea.png)

试一下功能，会不会说修改了以后就会保存再config.config了,如果是的话，自己任意文件下载config.config回来拿到的password，就哭呀直接丢到config.config去提取去解密了

配置已更改，系统设置-重启生效

![](images/1695806477082-ba46e740-c085-4de3-971b-1dfb8138b0db.png)

去看看config.config里的--拿到123456的密码了

![](images/1695806531593-22fee5fe-f64e-4ada-92fe-94dc0d60cdfe.png)

debug调试--还是原来的思路试试--结果就比如我下载回来的config.config文件里的`password`加密字段-我是不知道的，然后我直接就丢进config.config文件里直接就解密了

![](images/1695914765387-c048d75f-4045-41d1-9fc6-6b9629a2bbff.png)

![](images/1695914049861-c120ea59-a74a-4e3c-bf8a-ac01ad2e6f7c.png)

![](images/1695914482590-2c30df5e-832b-4622-8516-5677d4210b62.png)
...
![](images/1695914913670-bdb798df-a464-4718-a17b-77af6915826d.png)
...
![](images/1696603693083-2ad94815-aff2-4e11-b81f-6ef68d55638c.png)

1、前台文件读取加密exp编写-加密数据exp-获取key和iv

![](images/1706068084850-be19962e-b158-49b9-a775-72252c7b2820.png)
...
![](images/1696604683988-e2c8d976-8c91-42fc-a443-d337fa698f63.png)
...
![](images/1696640536728-89481c01-7aa5-4011-8e4a-34a92d9bf20d.png)
...
fileContents里，`new StreamReader().ReadToEnd()`获取文件路径`filepath`,而`System.IO.File.ReadAllBytes(...)`是获取文件路径`filepath`里的内容并且 读取到的字符串转换为字节数组，即文件内容的二进制表示 `byte[]`![](images/1696649033225-c270b1ab-a066-4a8e-b06b-193c2399a51a.png)
...
![](images/1696648218666-93c43a97-31e0-46d7-ba85-0b4299c04dc7.png)
