...
![image.png](images/attach-bf3ac582950a81d88a060b9b98f2ad9ac0ffe098.png)
...
![image.png](images/attach-b33761aaa7afe71be635219555237963578a4ba3.png)

查看两个文件，发现它们没有什么不同之处，定义了ROOT，然后进入APP:run()。除了admin文件夹下的index文件中定义了一个常量ADMINDIR。

![image.png](images/attach-c8168e7b7be8c68193bf9dcb868633708a6fd907.png)

跟进APP:run()，这里是整个CMS的核心。

![image.png](images/attach-d93e025448cb6134c2b6433c8846a0d0a218bbff.png)
...
![image.png](images/attach-ca151b64aad9d02fe0d550cc157982439ec29842.png)  
...
![image.png](images/attach-154788dcb63f6e9d8d0e6981e57a3ca35c9b06db.png)

同时，admin的data只赋值一次：

![image.png](images/attach-f20e0325750b0a3e5f159a01560ad94c9e0170f1.png)
...
![image.png](images/attach-142f7a76fde78fdfba5f65ee53ec98a0c568bcb1.png)

引用过滤函数的则是这三个，如果其他地方都是由此处获取请求参数，那就无法造成SQL注入。

![image.png](images/attach-8acb6d3382a400645cd68ca629c6f5dd5bbe41fc.png)
...
![image.png](images/attach-9529b92745144ddf3a67cb947ac3077320dac419.png)

![image.png](images/attach-0d31602b884dcd17cb45d31ac01a76343126cc5c.png)
...
![image.png](images/attach-e274d942686a439152144693ef345f5558e2245c.png)

![image.png](images/attach-14d6220ccd315aeb712302b0379a4a633e686635.png)
...
![image.png](images/attach-8e7e94d0835b560e452610ffc71840ba78611e09.png)
...
![image.png](images/attach-6fa52670b4943b4da6085ed5c2a51503c3a84b84.png)

这个GetIP()是没有经过过滤函数的。虽然大多数CMS中这个IP是不可控的，但笔者属于不是很信邪的那一款。于是跟进GetIP函数：

![image.png](images/attach-3f15ebc6c7fb19207f480ac9710ff4e8c2908491.png)
...
![image.png](images/attach-514096e92cf2c5628b27235e4973da353619663e.png)
...
![image.png](images/attach-33a9ef5736398ab9cf1cd9fa16ff6e82bd186aa7.png)

使用此账密登陆，成功：

![image.png](images/attach-8c225f9dfc8b8a852d88fe66f3d0d6fb89e9fb2d.png)
