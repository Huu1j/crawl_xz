...
![image.png](images/attach-e1b8c78236af0adb8b6c076ce20163a58dd81eec.png)

shellcode功能
-----------

![image.png](images/attach-f41e35ac2c5cbb99a1eafe00ae1e44bf287e155a.png)  
...
![image.png](images/attach-809936894dd7ec413d05222823a1310e2309b69f.png)
...
![image.png](images/attach-05069df75e24960183ed91d82aa931c8dd3eecc1.png)
...
![image.png](images/attach-9a009cabce32bf87ceff4dcc04e486d93daa8db1.png)
...
![image.png](images/attach-aefb8634c477256a393711641fade5924b5d13b1.png)

成功抓取到了数据包  
![image.png](images/attach-0311ac2b059d4885d109aad583d57a29bff63785.png)  
...
![image.png](images/attach-80e717b4afe5ed22d11842fa61adade6e51441fb.png)

0x2be43=179779(十进制)，这个值对应了metasploit向我们发送的载荷大小。

![image.png](images/attach-68d9abe6c24d636cb85eba39cdc5d83e0d8c05c1.png)

接着看后面的数据包，从图中可以看到，msf向我们发送了stage的开头，上面提到过msf不会一次性将整个stage发送过来，所以从图中可以看到metasploit一直在发送数据。

![image.png](images/attach-c1e5ce4220881d752f25dc1ca00ea5daf5155ddb.png)  
...
![image.png](images/attach-70ffc0e6c1459d6f61d6428a68c0f3cb666bfa70.png)
...
![image.png](images/attach-f69c21d7ebb31ef516d6f17c348c0b44349f02ca.png)
...
![image.png](images/attach-1035b2fc6ff208fc8a8937641d3caaafbfd5fb9b.png)  
...
![image.png](images/attach-4e30d78a02dfc6439c82ade4f5c2e5e77dc23ef0.png)
