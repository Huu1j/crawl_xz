...
> **来源**: https://forum.butian.net/share/2809  
> **文章ID**: 2809
...
![9239-article-blackhat_diagrams-08.png](images/attach-21439a8d5ab253101219c04d68ded2d849880972.png)  
...
![race-conditions-discount-code-race.png](images/attach-573ac73f21de5f4078dac35a21bc26be6be0653f.png)  
...
![image-20240314134735760.png](images/attach-99dd3f027c9bd8d1c1a78f01283842946fc82f9e.png)

多次尝试后发现折扣被多次使用，低于50刀，可以购买：

![image-20240314134819859.png](images/attach-86122e0ac81f134984b98160c30875d313e2c9d1.png)
...
![image-20240314162525019.png](images/attach-729f0efb53d04e0875312b7ae1b7394463dbb70a.png)

将password改成`%s`并在python代码中爆破。

![image-20240314162500363.png](images/attach-1a6c974d11f96fc8ae4be9379a15ec027aa5ffc7.png)
...
![image-20240314195242462.png](images/attach-db319172d30ad289befc36fd893c5a17a3865658.png)
...
![image-20240314201009126.png](images/attach-cb38bb8a719013f8fcd1077b7a1a83d1ee9445c0.png)
...
![race-conditions-basket-adjustment-race.png](images/attach-8cd4f70b9547ef924c931e6d1f9a66119e0caa34.png)
...
![race-conditions-multi-endpoint.png](images/attach-01e93b5eaf7b76fa8e4481c50fabb9d4b808c8b2.png)
...
![2eb6-article-client-sidedelay.png](images/attach-63a91dc5c60797a0576822b358068f392469c032.png)

第二种方法是利用一项常见的安全功能。如果发送请求过快且数量过多，Web服务器通常会延迟处理这些请求。通过发送大量虚假请求故意触发速率或资源限制，可以造成适当的**服务器端延迟**。这种情况使得单数据包攻击变得可行。

![1592-article-delay.png](images/attach-854247828153c8f802eb99624f870aaa1a417ffa.png)
...
![race-conditions-password-reset-collision.png](images/attach-63a4957698c6fdf3b3a6c72d5bf77fb87cb8f721.png)
...
![image-20240315150151640.png](images/attach-0cfc9ad26ad23d1d46ae609ea00ce02f7c68de9e.png)

![image-20240315150212416.png](images/attach-07a38bf7570274f26fdc0df108d88a51f273e4f9.png)
...
![image-20240315161747353.png](images/attach-59ce5af4b7a731da4595fa851ae502ac9f47d012.png)
...
![image-20240315192331985.png](images/attach-9c3b057d9e20a1bad20b9c56487c476428c2d76d.png)
