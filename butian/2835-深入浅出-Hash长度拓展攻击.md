...
> **来源**: https://forum.butian.net/share/2835  
> **文章ID**: 2835
...
![Pasted image 20240325130143.png](images/attach-23de779a10627761f1e718cbc9254d0034b0de1c.png)  
这里就是9\*8=72个二进制字符
...
![Pasted image 20240325230337.png](images/attach-08039864c56edd48bfda581f9ffe29415d07fdda.png)  
...
![Pasted image 20240325230729.png](images/attach-d59c30d2453c8cd215b62050099697bc258a5cc0.png)
...
![Pasted image 20240325233012.png](images/attach-a2923920378701149b7fb1988b11adadb6bc4ed9.png)  
然后在加了salt之后就是加入`yusa`后就是

![Pasted image 20240325233108.png](images/attach-72109b7946a332f9b03c3486d916098446e8397e.png)  
此时的原始数据长度就是21\*8=168bit，转化为16进制就是a8  
填充后就是这样

![Pasted image 20240325233518.png](images/attach-0d91a1f048cd0a3b77b2999bd67fd8c4b15ea246.png)  
...
![Pasted image 20240325235635.png](images/attach-73c74513b3f586f37ba6fcdd082cf10129736777.png)  
这个是完整的一个数据块，那么此时我们如果替换完后把他变为

![Pasted image 20240325235704.png](images/attach-066b67f2720f2917d673fdf818c63da24ccf6280.png)  
这样之后那么是不是在服务端就会再次对其进行填充和多轮压缩，也就是这样

![Pasted image 20240325235836.png](images/attach-717718549e5d4a24086a9a61d804220d0a2e52cb.png)  
