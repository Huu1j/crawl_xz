...
> **来源**: https://forum.butian.net/share/2677  
> **文章ID**: 2677
...
![image.png](images/attach-f0ba6b31133234f9e2e359f78e9639ea2e10561e.png)
...
![1.png](images/attach-07d80a0948c061a324bf40ed260959ba86820649.png)
...
![2.png](images/attach-ee0b02edaab0c6fa24154e515dccf9581409c7a0.png)
...
![3.png](images/attach-71af85f9551792573048f206ca7f65c9c03ae2f4.png)

把这个dll直接丢到ILSpy进行反编译，在左侧栏中找到对应的UploadFile

![4.png](images/attach-2dda8d29ac3e23ad3e364a3506b36601dd5f45f9.png)
...
![5.png](images/attach-5959afd77739ceb143aff490c9f0f0c9f9562d78.png)
...
![7.png](images/attach-495f8b191643d0a404773c219961839590ca40ea.png)

通过逆向搜索看看谁引用 *AVA.ResourcesPlatform.AdminUI.Services.WeikeCutOut.UploadFile*

可以看到是 /Services/Convert/UploadFile.aspx

![6.png](images/attach-a3e58d810059e88209761dc85df0189b60e70c05.png)
...
![8.png](images/attach-5c11cf6136a41c84c8278f9524ee26e9ab12245f.png)

但是在利用的时候发现上传aspx失败，换后缀asp、cer会出现403，于是利用创建文件夹的特性，去创文件夹穿?

这时候访问显示500

![9.png](images/attach-98245d62455b528ed60de855546302eb1a48ac86.png)
...
![10.png](images/attach-723febb47d2564c9977d8dfa20d654d4b8028d82.png)
...
![11.png](images/attach-ab5923f3aa8b001f54fb69f741e9619d1dc4b763.png)
