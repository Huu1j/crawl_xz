...
> **来源**: https://forum.butian.net/share/2844  
> **文章ID**: 2844
...
![image.png](images/attach-08fbe5861fd89f228a88e35e74344d85cce621a9.png)

![image.png](images/attach-58019008488bb7fd8f7740c071dff9ded37c079e.png)
...
![image.png](images/attach-ee17af39c1af8349d7b8bb3e38910633f3f50e4f.png)
...
![image.png](images/attach-c9c8bb47a5f7621c808de21b0680a8c38c661892.png)
...
![image.png](images/attach-c9f907ec7027fbb063e2bc7c95c50bbb4e0ec9a4.png)

即可通过伪造这样的回显数据包，进行密码重置流程的跳跃，直接跳到修改密码环节。

或修改密码时，根据的是mobile参数而没有对mobile参数与cookie值进行绑定，即可直接对moblie参数内容进行替换，以此直接修改其他账户的密码。

![image.png](images/attach-7932f0a490a0f32a5b8332a2112513a793d10b9d.png)

使用手册
----

![image.png](images/attach-dea8478d38dc4a470d1bcb8a5ee52d0906ab0619.png)

通过操作手册，以获取初始密码，或密码和账户的命名方式，生成更有针对性的暴破字典进行暴破。

![image.png](images/attach-121101ebb122ab30298de78d76aa71c0f21cd521.png)
...
![image.png](images/attach-b845759e2c52928faff90cc7a87b8312f554f85b.png)

![image.png](images/attach-2da07c8be0720528db412c9670a8462eb19834ea.png)
...
![image.png](images/attach-b915e22f6c104b714c74dde7a786e5b5d47200b5.png)
...
![image.png](images/attach-e21885ff4675a659622816a674473774dba01e6e.png)

![image.png](images/attach-259d1dd593143249a34acc08073d27b1af53a7b7.png)
...
![image.png](images/attach-43b26bbcaebf4eeffd09822bd1aa47dd23b7226c.png)
...
![image.png](images/attach-8f7e7bb9c2a2fff13693af989f807bfb1699bdb2.png)
...
![image.png](images/attach-19f762d2f29ce8514001ef3e2e503b479a68ddad.png)

攻击工具：

![image.png](images/attach-001a6268308a54d4ae51a4ad894b2268c774ac7e.png)
...
![image.png](images/attach-432f7b15551663b337926120968a678129600e64.png)

进行手工验证得到Java的版本为1.8.0 。

![image.png](images/attach-056773bbaf1188b36c43b5dd1fcfdaf0ed061260.png)

![image.png](images/attach-bc94332d9192251b4b251ff91b5c1e4d5e7cf6be.png)
...
![image.png](images/attach-fa4aa676a5d71ae6aa482abee78b4583bc2aadd0.png)

直接拼接或与其他路径进行组合拼接访问。

![image.png](images/attach-56777b244d651ac280baeac9b76bf439e4c8f67e.png)

![image.png](images/attach-8c749e338b42e849a4cc9c5f310a31bd9e112a9d.png)

通过不断的报错信息以进行请求方式和参数的构造以获取此接口的信息。

![image.png](images/attach-d6d0618b61033f10af93e105e0c4031cb26fc107.png)
...
![image.png](images/attach-5440eccfe5b386c5feecb3ec399121b3d7b973d6.png)
...
![image.png](images/attach-6fa7b6b9550697cb03dd0e794f5c07b2e124f5a1.png)

![image.png](images/attach-a116cd60febd374eb17c4ffecedcdd7b3e00e4bd.png)
...
![image.png](images/attach-38d535502964dedb9a75822ae349505f1dd82a2a.png)
