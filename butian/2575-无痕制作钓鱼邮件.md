...
> **来源**: https://forum.butian.net/share/2575  
> **文章ID**: 2575
...
![image.png](images/attach-cbd6382dd908a81081b148f9c2f05072b432c862.png)  
...
![image.png](images/attach-9d11f6762532d65db2b9b85b64e3f9179e306f2e.png)

![image.png](images/attach-89d0e8f5ed84141f6dca05ba63e47f1c5da8a214.png)

![image.png](images/attach-f12f8eb217bfe7820043072789efe5ed227e8442.png)  
**(2) 左边点 DNS-> 记录 -> 添加记录**

**(3) 添加两条**

![image.png](images/attach-260faa583c1f60d216f9b6acaa0cf908cad34dee.png)
...
![image.png](images/attach-dafd476b6f09bb18e9b080924d2775f0beda4d4f.png)

点击管理：

![image.png](images/attach-1ed1dec349f2c66275bdae5ad3bb875d2b3ec31a.png)
...
![image.png](images/attach-500ac630cbf119253d93d6aa6321fdd18c8afe38.png)

**(2) 点客户端证书 -> 创建**

![image.png](images/attach-5ad93303ba10382509b5894304dc307340e93641.png)  
**(3) 选择 ECC-> 创建证书**

![image.png](images/attach-8b3e2971ca277a3dab20cc118077ff59fec55ee1.png)

**(4) 左边缓存 -> 配置 -> 开发者勾上**

![image.png](images/attach-56c378d2ecaf8330463e6373782e939b81a256f2.png)

**(5) 左边规则 -> 添加两个规则 -> 选择缓存级别 -> 选择绕过 -> 保存**

![image.png](images/attach-5706fe03b8a1bdc831e32fd5e191a9ad42a3727f.png)
...
![image.png](images/attach-bf61a9191751dd5ab5e13b2d28a16f285342c0ce.png)
...
![image.png](images/attach-9a3ea6f3d3b4a41939dbc0a5e908e0edcabda9dc.png)

![image.png](images/attach-a162558f9d2eba16013303da34bddc367a0af126.png)
...
![image.png](images/attach-954b15b1b0544ddfa74f734f6e7f60f295f594b1.png)
...
![image.png](images/attach-413d606077e73b06d1e8928ad22e59190d9b91a5.png)
...
![image.png](images/attach-a4cbcad0622465e2dbaab79f92f9d422a20d0010.png)

![image.png](images/attach-2705ed47fd6f0a5e02f1f7c6040e88b25e31c464.png)
...
![image.png](images/attach-c57b0d4b88fd42a2fe02aa9c01c0a36a51e34303.png)
...
![image.png](images/attach-6ca5bf6ab69b131a7c1f31bed8c3867fb1c91c29.png)  
X-Mailer:Foxmail 6, 15, 201, 21 \[cn\]

![image.png](images/attach-13ba0bee832cae6ec77b91288d1e53c900cf4664.png)  
这里可以发送一封测试邮件进行测试，如果有收到说明就没问题。

##### 5.3.2：Landing Pages 钓鱼页面

![image.png](images/attach-372c202f125fd4961c5d356ea048928b97287e84.png)

![image.png](images/attach-f0a623592422c41f7b3b26f418615a36b2d0bd1f.png)
...
![image.png](images/attach-f26d81a8af27c74a71c01596ca9f7a4baaf79721.png)  
这里给一个做好的模板照片，导入.eml格式的目的是为了套用格式使其看起来更加真实，如下图是我做的一个：

![image.png](images/attach-8c18c1fbd4622f9553850578c8d61a643fca5acb.png)

##### 5.3.4：Users & Groups 用户和组

![image.png](images/attach-16f7097905806d8633f997b4377da34dd9cbaa9b.png)
...
![image.png](images/attach-9afda6a7ed164cc041d864f8e9c8aa13ea1c3bc3.png)

url：填入我们之前cloudflare里面设置的域名

![image.png](images/attach-929b6db0444b82d28b5202b794602633a93d2879.png)
...
![image.png](images/attach-1eedce98f1329c9c750416c1b4edb045a8d67807.png)
