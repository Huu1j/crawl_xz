...
> **来源**: https://forum.butian.net/share/2750  
> **文章ID**: 2750
...
![image.png](images/attach-2238f17d351051dd36d5444cf3ed39a70cbd278c.png)
...
![image.png](images/attach-c7286f4a808f42fe018764d1ee29af05d31734d5.png)
...
![image.png](images/attach-fe92e50cec3cf30fa889f54cd87b657949aeb857.png)
...
![image.png](images/attach-cdec8d65c18370fc661379158dde3f98d5928254.png)
...
![image.png](images/attach-4e1b18219015fc8023dba260639be2da4fb7f90d.png)
...
![image.png](images/attach-ed3568fce19b6f97c3fa208964f26404defe0d5e.png)
...
![image.png](images/attach-b7adc760daae6fdc90c0e9564cab41993cf323bc.png)
...
![image.png](images/attach-d59a6d08c568b8459d3ac91f4550cfdd974309ca.png)

#### 6.4、类型比较表（略）

类型比较表：<https://www.cnblogs.com/zbligang/articles/12143102.html>

![image.png](images/attach-4afc1e749c4c24838374d30f176a3a6e4288ebeb.png)  
‍  
![image.png](images/attach-b3681f7f74475a031ecc12818b8898c21fb75f3a.png)

![image.png](images/attach-fdde3eb4bf4a1d91b7251fb81ccd6a7a59de234b.png)
...
![image.png](images/attach-382682b6a23316536ae3899314ede300f27130b1.png)
...
![image.png](images/attach-9665b3982cccbae22784faea6150eb283519518c.png)
...
![image.png](images/attach-2ed1b6d8b9e0a5986984ac979926d326e58b951c.png)
...
![image.png](images/attach-48c8c90151589e5d7e1d1aead1762c7974c56e66.png)
...
![image.png](images/attach-283e7592aa3dc47a3b661f4c07b40cd06120dfe0.png)
...
![image.png](images/attach-4c6a6c2aaa91cf0836ae27b6c078583851cffa6b.png)
...
![image.png](images/attach-61087cbf3fa40386a94f7fe662118c63e8b79ba5.png)

2、确认执行路径/攻击路径

注意：这里的关键点在于，最终执行的后退一步，进入到这一步也就是红色的3，那么就说明成功绕过

![image.png](images/attach-d1f15056c1466232accdc2c1022319bf1484750a.png)

‍

3、区分功能模块

![image.png](images/attach-42392c82f0434546882c62aaf753a67b2843f71f.png)
...
![image.png](images/attach-3e2b3a9bd5b6aa51c4a269372f352249d1c11a39.png)  
‍
