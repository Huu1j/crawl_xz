...
> **来源**: https://forum.butian.net/share/2669  
> **文章ID**: 2669
...
效果：  
![image.png](images/attach-a4b9acf50daa5d0e9924c0088704607567b6dfd7.png)

![image.png](images/attach-a4b9a9077a2048ae6287e587de9084e34ad6780b.png)
...
![image.png](images/attach-013d9e9776266b57442b1cec577ffa37912f3385.png)

`e8 call`的格式是`CALL Jz`，那么这里的`f64`和`Jz`是什么意思呢，继续翻官方文档：

![image.png](images/attach-1128799c04a1a9d1986d72a0c6d34f28ee4a0e1c.png)

![image.png](images/attach-cb33c12555fd5341d7b61da81eed8d3ff1951239.png)

![image.png](images/attach-ea4c0199abbe1ed3eb405f88f6deb7eba858818f.png)
...
![image.png](images/attach-047ff730d63d31aa612b62eceb9318ffc28a77c8.png)

![image.png](images/attach-90de6001f12e338513a32644d42b4e972ff1a6ed.png)

![image.png](images/attach-a20241dcf698c13ad3ed3368a316c830f0ae8ed1.png)  
最后将算出的四字节偏移填充到`e8`后面就好了，比如我这里按照Windows的小端存储方式，最后的结果就应该是`e8 2b 10 06 00`：

![image.png](images/attach-a100f493aeb16d5cb1ed601d9029ccc2c0026216.png)  
...
![image.png](images/attach-e7d1769f2cfccd866cae0e2eb279da2cc0a2a81a.png)
...
![image.png](images/attach-2971ace3714965b508d65c314098f10ccde6d145.png)
