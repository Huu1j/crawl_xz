...
> **来源**: https://forum.butian.net/share/2454  
> **文章ID**: 2454
...
![image.png](images/attach-94ffa127024a7979cd6b2035f0dd2b67b7d1281e.png)

或者伪装HR联系求职者

![image.png](images/attach-e229655ad6534e5d73305cde1df464422dbe69a6.png)

### 投毒

在github，公众号等地方投毒

![image.png](images/attach-d984dc1c4522a3864ddbbf155466e7c905caab30.png)  
供应链投毒

![image.png](images/attach-9ca160ff6dd289c5d3ea1d365e8c1c9f80d8fed4.png)

### 社会工程学

通过在社交平台寻找疑似工作人员（重点关注微博抖音快手小红书），然后通过OSINT定制化钓鱼攻击，博取对方信任，然后投放木马

![image.png](images/attach-3117ebd4145f677f9950d29cbb1c87b630ef606f.png)

### 仿冒IT运维人员

以密码过期、系统升级等理由，要求打开链接输入账号密码或者下载恶意附件

![image.png](images/attach-9211e3b1d27fcfeb24c184d4aff1a9fe2a678b51.png)

![image.png](images/attach-f17c068d0f73ee6bb3b648c3749d51a4a0278c5d.png)

![image.png](images/attach-f5e50972d8bdcb011a875fad3af77acffa443175.png)

### 补贴

![image.png](images/attach-8007acb551b0bd46f2527a68db89e4cf5444efc1.png)

### 吃瓜

通过捏造吃瓜事件，吸引受害者点击恶意文件，在攻防时慎用此方式钓鱼，可能会被警告（21年某象）

![image.png](images/attach-7ddc49909dbb2185a6c42b973befe185195a8dca.png)

![image.png](images/attach-67c84056ac0819bf603786de8005ff408d9cd5fa.png)

![image.png](images/attach-2c560e1617ee4180ecbb58b0c14f68f100a2a4fa.png)

![image.png](images/attach-27ae1e579fa176e232a1874ad1d731dcab11be57.png)
...
![image.png](images/attach-95f23b7a7f361935363205ce5e155e3bdd1b7c8a.png)

将conf.inf文件和wwwcomw.dll文件放入到和劫持的文件同一目录，点击运行即可执行shellcode

![image.png](images/attach-49e71cd2be6f820a30a1949b6fa7ff90b3190fec.png)
...
![image.png](images/attach-2cb87e49b7bf360cb3d7ee404e26c27bd7242fb9.png)
...
![image.png](images/attach-5d1deae22690124538c14ab969967cef62a3ca6f.png)
...
![image.png](images/attach-d741763c9134dec69621b57468402d7555a1f7be.png)  
...
![image.png](images/attach-6f26c5e8e2ac2a7069eb1719ed403aa387fc595c.png)  
尝试读取文件信息
...
![image.png](images/attach-0ea1df9d86c3437b210a57fbd910862ef596150a.png)

对邮箱账号进行溯源如“@qq.com”、“@gmail.com”等此类字符串，搜索账号等，如果使用的是私有域名邮箱，可以从这方面入手，有次就碰见EwoMail邮箱管理后台一般为8010端口使用了默认口令admin/ewomail123。

![image.png](images/attach-820b263f0c9cc859dd7997a054c2cbad88da1d11.png)
...
![image.png](images/attach-f2a5c3ec477e21d0320aa182484a49b2b1552d5d.png)
...
![image.png](images/attach-835e34491ac901757011291d8d42d15299043c10.png)  
还好当时留了个心眼儿，用沙箱跑了一下，发现全是木马，也是学到了一波。

![image.png](images/attach-c8144acf2c871bdfcfdc9923a98ca76d961f49df.png)
