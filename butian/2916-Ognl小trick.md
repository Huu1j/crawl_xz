...
> **来源**: https://forum.butian.net/share/2916  
> **文章ID**: 2916
...
![image.png](images/attach-4e97a96925fcb6543ab0b4f4b1ecd7934e9e625b.png)
...
root：stratt\[1\]读取  
![image.png](images/attach-0876c0b065be2fa03215ad7d31d7fce833df5a87.png)  
非root：#people1.stratt\[2\]  
![image.png](images/attach-c489b57d66aa8a5116c5cf3b099989df3df7fa9b.png)  
也可以用Java中类似的方式新建数组并且访问：  
`new java.lang.String[]{"a","b","c"}[1]`  
`new String[]{"a","b","c"}[2]`  
这两种方法都是可以的。  
![image.png](images/attach-98fc05f174b602369d1e97765ab5d7082deea6a2.png)  
Map同理，可以使用key的值来直接访问value  
`#{"A":"a","B":"b","C":"c"}["B"]`  
![image.png](images/attach-17d9d02c5207b3f78b07292f1a055e5ec7da0ce9.png)
...
![image.png](images/attach-6784196504a8a3c27a38559241487203d4f58b5e.png)

![image.png](images/attach-155c805cbae2d86348bbe2f003633c1252d7b6ce.png)
...
![image.png](images/attach-ebec054ae40074195d37fdc2dd44757bfe8a622b.png)

线上同样不放图了，被警告了，使用的话是可以成功的，那就试试直接r呢？

![image.png](images/attach-e3694177f78cdc0ce084a3538db14e8a57d45a17.png)
