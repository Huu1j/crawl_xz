...
> **来源**: https://forum.butian.net/share/2940  
> **文章ID**: 2940
...
![图片.png](images/attach-5d63968216ead168054b386221a08425653199ce.png)  
抓个登入包

![图片.png](images/attach-00e254a6d46b84e61c98ac35b31ee49a580e6349.png)

![图片.png](images/attach-3327e831eb1c6a4150af236339021790b86bb80b.png)  
加密了,翻翻源码

![图片.png](images/attach-bc337e37dd48a6d519a635caba431dfd49ce6d49.png)  
是Encrypt函数加密的

![图片.png](images/attach-b7d92959c4e744f5de6e52082b451df250a07f50.png)

key是wx.getStorageSync("key");获得的

![图片.png](images/attach-5f86aab2041ba2d40642c4c430b3ed8e3039a2dd.png)

key是g(e)获得的 看一下什么东西调用了getKeys函数

![图片.png](images/attach-a9d73cd5b67d779e07575a674341d53cea28531b.png)  
是某个请求包的返回包中的参数nonFixedSax和fixedSax

![图片.png](images/attach-978f8ff48c7cc36bff35173cce26ea1c7241fa13.png)

小伙子挺会藏的呀,我怀疑我在打ctf

获得key后走了个g函数

![图片.png](images/attach-6989b896134b1079f4147d894475abfe37403a9d.png)  
g函数就是个一个加密函数

![图片.png](images/attach-140701b005893dd9fb34094647124be5077a00d4.png)  
获得密钥试试

![图片.png](images/attach-b46c27f6f4261f1b8fb0d1318ac00c61ee1d7a96.png)  
可以解密

然后尝试修改id看看可不可以登入到别人的账号上面

![图片.png](images/attach-dd5bb452a57e5a74abfb9de8372c95e2b3ea1c26.png)  
发现请求过期,应该是sign搞的鬼

他先添加了两个参数saltValue和timestamp当前时间戳

![图片.png](images/attach-1b376bf0e9f6589da21894b3630dccb1aca034f1.png)

然后进行了排序首字母大小写排序

类似于这样

![图片.png](images/attach-a253a4cb506eb3286d67974dfa75871446daa5dd.png)  
然后???
...
![图片.png](images/attach-d6c1cbb3fa63ead31f5201fe17cc4d9691b91ae3.png)

写一下js构造了一个js脚本

![图片.png](images/attach-8559ec3d0ac246b9e1e01e025ab8d24ed39a1d35.png)  
然后放到python中,js我实在不熟

使用execjs调用js函数

![图片.png](images/attach-e82311019c46d5c2bfe75128f9f65fc1baee1a32.png)  
这样sign和timestamp就搞定了

![图片.png](images/attach-38124274c8c897f8a408f72f37fb1e43a1db1e04.png)  
...
![图片.png](images/attach-f28426eb03b90bf7dbd070f5c06d8b0b18a8942e.png)  
搞成list,函数就填几个可能的参数比如userid和id什么的

然后python梭哈requests配置一下proxies到burp

![图片.png](images/attach-739184f530ea38d116c29b429cd34f8efabf6abd.png)  
burp查看结果

找到了一个接口可以通过id来查询到手机号

![图片.png](images/attach-026a01d94c86b09f05beb9b19a2868089595c763.png)
...
![图片.png](images/attach-a2c0248b5b1ab9c1f1d57089c3a9fb56642f746c.png)  
获得token

burp替换token尝试登入

![图片.png](images/attach-91eaf3f9fe46566d3fc4bc54b1735ff97fb82f0d.png)  
刷新小程序

![图片.png](images/attach-02802cc5d859aa6d68faf102f78f6534bc884c69.png)
...
![图片.png](images/attach-7eac702b72d409b30de71439cace2e9a19a17406.png)  
转载于：yier的博客
