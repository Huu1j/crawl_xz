...
> **来源**: https://forum.butian.net/share/2475  
> **文章ID**: 2475
...
![图片.png](images/attach-12230fb279e05c707f5cc7661c05fdf1de3bca23.png)

随便找一个密码去解密比如：7FEF6171469E80D32C0559F88B377245

![图片.png](images/attach-0e99fbd9fe2063d9dab84f7123a07f267f3b5d61.png)  
就得到了默认账户admin/admin888的登陆口令，现在去登录系统的用户后台。  
[http://localhost/member/member\_login.php](http://localhost/member/member_login.php)

![图片.png](images/attach-f1a3aa607cae4e82bcba9caeac3afe661cdeaf84.png)  
...
![图片.png](images/attach-04e0edb3a6b8d387dcb7c6318d90b93081efbd62.png)
...
![图片.png](images/attach-eaae565b1a7dd014f1b926a2f71ffbc3e92ee2bb.png)

防护代码如下：  
路径：function/function.php  
如下图可见，POST请求经过了正则表达式的检测，如果匹配到敏感字符将会die掉程序终止执行。

![图片.png](images/attach-911ee9d253ced60d2438dd1903554f35b4494ff9.png)

![图片.png](images/attach-ea41855164193c79abc3bae73fc61f28c7feb367.png)
...
![图片.png](images/attach-b9d97c266b3b198e1f2c32ab404d04ee6b437d62.png)

那么就可以使用html实体编码sql注入payload用来绕过检测。  
比如'的html实体编码为&#39，然后url编码一遍可以看到执行语句的日志。可以发现成功的绕过了检测，并且进入数据库的字符也被解码了。  
![图片.png](images/attach-7b42e3c0ba191352d725a9bd105d4ac8d3c30a63.png)  
直接上payload，注入获取管理员密码  
`%26%2339,M_info=(%26%23115elect a_pwd from sl_admin),M_add=%26%2339`  
![图片.png](images/attach-08b0b27b9d1fe7a72f6f368a7742ecb3f860765f.png)
...
![图片.png](images/attach-72e7f8a29e73758f6bff74b5b11d8e819d049c04.png)
...
![图片.png](images/attach-55cbd27c0e8e8660e33dc843486686b10538d64a.png)
...
![图片.png](images/attach-a81ffd41f01a965227bade131a80f2d00deb9689.png)

![图片.png](images/attach-80ea47cf3b18c177b8cddbf2b74232037f1c357b.png)

首先在config.json文件处加上允许上传php

![图片.png](images/attach-b3d8a1174057ecd37add09cfcf086942f10e251e.png)  
然后到后台修改一下安全配置，设置允许上传json格式的文件

![图片.png](images/attach-5a162c9fb85e503b920306a386563a0a9220d3dc.png)

然后把刚刚修改好的文件上传覆盖掉原有的config.json文件  
![图片.png](images/attach-06a4cddce3d92374811b0ccf81e9ef0cf57288ac.png)
...
![图片.png](images/attach-91817d800f8f79da48c5aece16988552cc20cb2b.png)

![图片.png](images/attach-dd0c60c0a8696be3873355da07f4104934b7fee9.png)
