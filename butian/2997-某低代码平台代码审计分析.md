...
> **来源**: https://forum.butian.net/share/2997  
> **文章ID**: 2997
...
![image.png](images/attach-265c7540db3ca2aab9f1289b1aaba65e3f125ce4.png)

![image.png](images/attach-be1741cf907f0d877a66f5a80f3372d7ce1bfe21.png)
...
![image.png](images/attach-b23ba53120b0ff7d4bf4bf352ee26e402a95c9bb.png)
...
![image.png](images/attach-a1bd0fb730e3e02940198600f0543f9b83698339.png)
...
![image.png](images/attach-5215c3a22bde778db7d94a238697af4b1aa8424c.png)

但是这是怎么来的呢，这里我去翻了一下数据库，在je\_document\_bucket表中

![image.png](images/attach-436a50851aa29fbfa84b397ad8b2d37bcf9e5b7d.png)
...
![image.png](images/attach-4bad4f8aaf1bb4e958b25df8e231757ca3fdb418.png)  
所以我们就得控制fileOperate的类型，而这个正是之前FileOperateFactory实例化出来的对象，

跟进工厂类

![image.png](images/attach-338343f5ca2a672782b21af6493f2c3478898b5b.png)  
会走到local

![image.png](images/attach-9bd0636786c4c8a8123eaac1e0f57baf20455c0f.png)

而disk-oss是default

![image.png](images/attach-d0a7c9ecf5900ce8406f4613e41f01615d709db9.png)  
所以会走到local的upload file

![image.png](images/attach-2ecf74903ba6827dd8994a8dd6fcfda1d4ea3410.png)  
当bucket类型为default，就会是

![image.png](images/attach-66392801a1accbab160400ce964739392e5b5e35.png)
...
![image.png](images/attach-07823f3a4633b3f43ace1f630d38cbfc5991ed6e.png)

然后最麻烦的点就是这个文件名，fileNameGenerator​​这个方法会用uuid再生成一个文件名，并没有沿用前面生成的fileKey，所以在最终页面回显的时候，看到的fileKey并不是文件名

![image.png](images/attach-c5aacb5832eb45d0ba33bd7cb2f7c09c2a0ee0ab.png)
...
![image.png](images/attach-2aac57a14330cc62cf183ae7654e6f0fac608cf5.png)
...
![image.png](images/attach-c412fa799b2a328be9e0c3ad10803cdd710900f0.png)

![image.png](images/attach-955245996c5473e3420ef9d4150573f28c441bd0.png)

![image.png](images/attach-7e5bc623633e19c94cf83cd525b0a96657ac3e13.png)

所以我个人还是建议采用document这个接口，因为这个接口的bucket是可控的

![image.png](images/attach-e1d2e6452faa97b11dfcc5eedd5fd23488089e3d.png)

![image.png](images/attach-11c108725c92d898bef0da081704da79451e7b31.png)

时间都是能对上的

![image.png](images/attach-67f993d9214523ac431a6adc68e9fdeb14a7c0e8.png)
