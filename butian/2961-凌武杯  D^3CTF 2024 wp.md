...
> **来源**: https://forum.butian.net/share/2961  
> **文章ID**: 2961
...
![](images/1714314472171-a742dd26-8486-4986-9e58-2767a3ca864d.png)
...
![](images/1714314531195-4bbbf325-6bb1-48b8-89f2-b9c272af79af.png)
...
![](images/1714313627490-461182a7-03b0-4df1-a16f-d94b81d35be8.png)
...
![](images/1714313627569-f6d49a00-b40c-472f-a22d-3eb3936d8563.png)

![](images/1714313627703-9a874472-dab7-4955-a7c8-4994228960a2.png)

请求包更改content-length可以截断body传递的值，现在直接改base64编码的部分即可，注意也要同时修改content-length的长度

![](images/1714313627690-2e4d5d36-5c82-4879-b626-106f8afe522e.png)
...
![](images/1714313627794-97da34c5-b25e-4734-98da-5b354328bb7f.png)
...
![](images/1714313628197-f19852d6-d972-4981-a730-1036683e9208.png)
...
![](images/1714315179418-8eeee9fc-36db-4346-8c0d-86b899250dde.png)

然后将一大段code处理一下，扔进去run，循环判断，开始push和pop

![](images/1714315334788-d41b4970-7d1f-40f7-be4b-60bdb19a004e.png)

其中如果是call\_interface，就把栈里的东西拿出来到vm执行

![](images/1714315101257-c62ffa61-79bf-4174-bb4a-f26dacf4c6e3.png)

代码审计和动态调试一下，发现read是从stdin读取28个值，写入栈底，即前面一堆0到\[\[short - 3\]\]，也就是说能覆盖最后四个数，执行自己想要的命令

![](images/1714315585396-6c45e9d0-80d8-40ec-921b-06326d71022c.png)

题目过滤的`call_interface`和`{{}}`，这样我们就不能直接触发匿名函数和直接read/write地址了

![](images/1714322475495-b969eaaf-3759-4610-bac6-87f1ad5f1866.png)

我们直接写入27个数，同时让第27个数是个大数字（例如99），覆盖掉数字2，这样会和下面的write泄露信息，输出的内容中stdout前一个就是`[[ 0 ]]`了，也就是泄露pie基址

![](images/1714316037532-5ce35671-7bef-48ee-8eb8-c6efc61b94f4.png)

![](images/1714321312398-5bb865bd-549c-4177-92e5-e38ed9d8947a.png)

调试一下，发现pie+42就是 `(function (...a){  return a.map(char=>char.charCodeAt(0)).join(' ');})`匿名函数的地址

直接覆盖后四个值，write查看一下，没问题

![](images/1714321351141-20f13e31-9786-4c4a-aa3a-b921d182da1e.png)
...
![](images/1714316886105-9dd3b985-7719-41fc-8189-2adb9c371424.png)

成功执行

![](images/1714317016658-3540f126-79a1-4988-8c14-2077dfd5443e.png)
...
![](images/1714317390225-09177ec5-d3ff-4d52-8530-0c53b1883493.png)
...
![](images/1714317433787-a93ced97-673d-4c88-842c-f5ac72d2d386.png)

![](images/1714317433775-9102335a-f552-46c7-9d79-4859631c10cf.png)
...
![](images/1714321562582-114f57a0-f4a7-4bbb-9da3-061076e0626d.png)

执行后查看日志

![](images/1714321595223-ac4d208a-f12e-4171-8440-98dee1180f8e.png)

![](images/1714317434014-a044b773-c613-459d-910f-117590640da8.png)

base64解码得到flag

![](images/1714317434050-46995088-aa47-4408-9e5f-47de703b02c1.png)
...
![](images/1714317699678-2f499e5f-ea5f-4267-97d8-92f2d4e11c83.png)
...
![](images/1714317778804-85b7f4d9-1464-45ef-b0e8-297eabb5912d.png)

申请了这个pci设备

![](images/1714317778938-64b3fb08-0b3b-4fb3-8b12-d9dfe3819579.png)
...
![](images/1714317779035-621dfab4-4271-4c27-8b4b-79575adf7871.png)

pmio的端口比较像这个

![](images/1714317779071-213ab28e-cefb-4ebd-99fc-fafcb2d31870.png)
...
![](images/1714318024856-a36bd152-c3ec-4ecc-ac4f-805bf6bf6008.png)

flag长度为12

种子固定的

![](images/1714318024970-c8d5da22-23ff-4256-bbec-58bc37efcba5.png)

应该是v2里面按种子来rand取然后加上地址进行偏移

xref一下rand可以找到很多

![](images/1714318024938-db89b9f3-2963-49f0-b2d3-95de0aca1292.png)
...
![](images/1714318024990-3d5644b7-3752-40d6-8efe-6d6fcd470e6a.png)
...
![](images/1714318024955-16ca9034-14e2-4072-bd95-e5409650a356.png)
...
![](images/1714318025568-35f3c172-8be3-471d-ac4c-8ddfc88aa667.png)
...
![](images/1714319556786-a3a02726-71b4-400a-ac97-04037520ce0d.png)

![](images/1714319556949-34f61541-2937-4e75-bcf6-722d26d80f07.png)
...
![](images/1714319629088-128655c6-9472-4dde-bc5d-447019ca0d37.png)

nmap扫网段，得到：

![](images/1714319635140-19004944-8541-4c3f-ac94-d25e3c6b5883.png)
...
![](images/1714319665821-5827ab60-f95f-4793-854c-4a743a61ecd2.png)
...
![](images/1714319932796-3fcda49a-1158-41e5-ad8f-f9868d9ce0cd.png)
...
![](images/1714320055582-96535a91-a92f-420f-8252-b853d20483b2.png)

访问，得到一个二维码

![](images/1714320072173-cd1a9196-5c21-47a9-9fc2-1324ba8a0ecd.png)

扫描得到

![](images/1714320101005-65a4762f-ec48-465b-b7e9-dc6104d56f81.png)
...
![](images/1714320257425-0c10cbc9-1317-4e67-8b8e-e5350b04d9dd.png)

解压，直接grep，应该是最简单的第一个flag：

![](images/1714320542230-d15ae2d5-8739-4972-a069-68366aae097c.png)
