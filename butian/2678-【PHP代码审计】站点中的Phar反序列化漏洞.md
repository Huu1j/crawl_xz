...
> **来源**: https://forum.butian.net/share/2678  
> **文章ID**: 2678
...
![image.png](images/f8601794320f43bc371127be731da0b5c7136b830ce83.jpg)  
...
![image.png](images/f888704b93fb7f145644fed0458bea3bd71e8ecffd370.jpg)  
搜索关键字`cutformadd`寻找方法的触发位置，找到html模板中存在`admin/Template/cutformadd`的路径。  
![image.png](images/f256894424ba3bbf95482e7c6773f797ccbd94da319e4.jpg)  
因此，猜测Template.php功能就是调用模板html并在浏览器访问时渲染出来。看了一下该模板html内容，发现是在`管理自定义页面`的功能中。火速登录后台找到该位置，提交数据并抓包验证。  
![image.png](images/f367198a1c79473e39fffe142b75d4c3a4b15c082ca2a.jpg)  
成功触发该方法，并且可以看到path确实可控无过滤。  
![image.png](images/f888356a0a3ea33c38261a1d1d438b2e5dc7d5e4830cc.jpg)  
...
![image.png](images/f990540cc9522fb94985102bb4ceeb68d5010880793da.jpg)  
...
![image.png](images/f334743393c3608eed09eec8241fa4130ce2d413450d4.jpg)  
配置好php.ini后，在cmd中用命令执行上面的poc.php就行了。

> php.exe poc.php

![image.png](images/f752419f9453b4043348ba2f851c5d8db3ed537a334ad.jpg)  
修改文件后缀名  
![image.png](images/f912881bf82c5ee643483f48f04c7aacc838a8757644c.jpg)

### 触发反序列化漏洞

登录后台，找任意的图片上传点，上传图片，记录返回的文件路径（后台中提供的文件上传位置很多，这里仅举例其中之一）。  
![image.png](images/f118602af0194e94f5b1e6b01755c20c7fa98ab2442b2.jpg)  
构造漏洞数据包，给path参数赋值为上传的Phar文件的相对路径，添加Phar伪协议头。`path=phar://./public/upload/images/65564c2937556.jpg` ，使用get传递`cmd=xxxx`。  
![image.png](images/f92494103ebab5c93ebd9b1f7bcc1c49f5029da31798c.jpg)
