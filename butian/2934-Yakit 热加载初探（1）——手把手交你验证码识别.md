...
> **来源**: https://forum.butian.net/share/2934  
> **文章ID**: 2934
...
![image.png](images/attach-0d99139137efdb0c6d2e60c1670720cdf0ec1bda.png)  
使用方式：把图片base64编码后POST发送至接口[http://localhost:7788/base64](http://localhost:8899/base64) 的base64参数即可

![image.png](images/attach-f3aa6f25351293d6c5823fa3cd7b7765da2800a3.png)
...
获取验证码数据包。  
![image.png](images/attach-47e00439c3b9797436f03082c89a553cfdaf00e1.png)  
获取登录数据包。

![image.png](images/attach-c1447126b1b0dac956d8e5b2295376919cdd3c1b.png)  
...
![image.png](images/attach-169c63c805e3271ba2afc37c6a2665f1f631dcd7.png)  
上面的代码注释都写的很详细了，通过`poc.http`发送请求验证码的数据包，返回包中的json，通过正则获取到验证码图片信息和验证码id。  
考虑到通用性上面的正则编写可以参考下图：

![image.png](images/attach-e2d7d0c6d3e33760d471de135f1837b31aa56e96.png)

![image.png](images/attach-f65a1fd3c9bb9491e0c08b81c2574baf5c9386d4.png)  
...
![image.png](images/attach-e47045f8b7b1d4c083274f234ceb8cb2ae0dd1c5.png)  
...
![image.png](images/attach-6a2c5ca1fd9b3725b7fe7ce3dfe937c8abb67122.png)  
我们在数据包中做好标记，替换需要的数据。在这个例子中是`__ocr__`和`__vi__`。我们待会编写代码替换请求包在这两个值。

![image.png](images/attach-996ea907895418cbdcc8b9133bb55a6fdf346a82.png)  
代码很简单
...
![image.png](images/attach-053507f93367d81d39d1959de3ee8e134a116bba.png)  
这里需要对并发设置为1来保证识别的准确性，延时不设置应该也是可以的。

![image.png](images/attach-3c8627d7923908d833d256e8c04f8aab1d337b78.png)  
