...
> **来源**: https://forum.butian.net/share/2428  
> **文章ID**: 2428
...
![image.png](images/f82993139e33b46f90c0f32103b5b31e6f702ea096a0d.jpg)  
Templete目录下为模板文件，暂不看；优先看web\_inc.php，还没翻几行，就发现存在疑似注入点=.=!  
![image.png](images/f658551e0ff44ece4d92a1b4c2eb43ef798b528e3f92e.jpg)  
![image.png](images/f883213252cc73c8ab29a45ae2fbffa8069cb570a03d4.jpg)  
...
![image.png](images/f7879400c3a00bfacf292019da6cd0be8a9b95b1fe519.jpg)  
继续跟进这两个函数到contorl.php文件。看看具体的实现代码，将他们翻译成自然语言就是：  
verify\_str()会将传进来的值进行正则匹配，当存在红框中的使用`|`分割的字符时，无论大小写（忽略大小写），都会退出代码执行，并打印Sorry  
![image.png](images/f862227329b7ff7fa3a89a5ed746309abc182cf83d94b.jpg)  
...
![image.png](images/f93607241bfdf87bc97b5ac2f0711269cf097360ebc23.jpg)  
![image.png](images/f188470e00b30d41a4c93dbe59d3fb23c7565c7304afd.jpg)  
...
![image.png](images/f27582871b972aabceace8359f2c03adb4e58c5e5f13d.jpg)  
![image.png](images/f1234988e743ef5581e344b7634d8c4abfad8867a067a.jpg)  
之后尝试构造sleep()语句，进行时间盲注测试。结果并没有触发延迟，并且服务器返回了500错误。  
![image.png](images/f3193841ef438cba523cbebcd973ef657cad5fcc9409c.jpg)  
![image.png](images/f7480736df39dc5bcca5b26fe29d0b53b0b514d8e0d42.jpg)  
感觉比较奇怪，因此测试找了一下原因发现：  
当sleep一个较小的值，因被带入后端进行多次sql查询，实际睡眠了4s时间；也就是说之前睡眠1s，实际睡眠了40s以上，导致超时返回500状态码。  
![image.png](images/f304083658423a60c9ccb14c2bfa40338ecfa82954175.jpg)  
...
![image.png](images/f352368a4ff12cacf59439b6b75bd53cca2ab232ed67e.jpg)  
![image.png](images/f139778e3db9db08dc15856f76163eda645a1ab89de5c.jpg)  
...
![image.png](images/f4000978f2be6c337033983ceac91ec490df0826ce5aa.jpg)  
成功获得数据库名称
...
![image.png](images/f202754f53221143192aa70df6f1122cdfb6d59a46e9d.jpg)  
查找发现包含web\_inc.php的文件还是比较多的，因此理论上他们都会存在相同的注入问题。  
![image.png](images/f4622734004601a23c63776c79e55c20a25782e02b6a9.jpg)  
以/Templete/default/Include/search.php为例，进行时间盲注测试。  
![image.png](images/f33273262c2f3793ab3700deae7e381ccdcc63b97f588.jpg)  
成功触发与web\_inc.php情况相同的延迟。  
![image.png](images/f21902431be2cd913ff874629971ba08066d3462d1b13.jpg)  
...
![image.png](images/f3171823d52b162e84d877d029bd84debcd9e0ef489ad.jpg)  
...
![image.png](images/f2826139037e4078a742ae4d32cb1f697456d56728530.jpg)  
...
![image.png](images/f173931071ba82fa4a78af1bae069cfa6cc1982a82cc6.jpg)  
当从用户表中获取的用户名不等于十六进制的Admin，等式不成立，未触发延时。  
![image.png](images/f9587320a741530565a37607aad396e2af78402dab473.jpg)
...
![image.png](images/f272212d54246194d7d5732c18fd97f6175b74e4bfb5a.jpg)  
通过web\_inc.php中的sql语句确定查询的数据库，在sc\_lable表中找对应的字段，为第2列  
![image.png](images/f62328065108844b9793b2a49067d517f82cdbbf4a263.jpg)  
![image.png](images/f93962412f7dc62f3c52a6fb43b386cbc90aa01d434f9.jpg)  
...
![image.png](images/f79057471a6d53889defb0225fdc528b90aa577509d4d.jpg)
