...
> **来源**: https://forum.butian.net/share/3131  
> **文章ID**: 3131
...
![image-20240621093621443.png](images/attach-db2406954dd06c76d45b2f4168768693d84520d0.png)

![image-20240621093344359.png](images/attach-19fcb5b2700d85655bc0fc1d9269eebcf26a4bd6.png)
...
![image-20240621093749221.png](images/attach-9e4ee14d767192b933879e7a29d8e3d1f6829a12.png)  
...
![image-20240621093812803.png](images/attach-a404e1342398ab02efbb2b86eff00300920cc5c5.png)  
...
![image-20240621094052345.png](images/attach-17fe2981827f7236997cf9ba33a949828ec73987.png)  
如下就是其中用到的StarGAN的结构

![image-20240621094126012.png](images/attach-03316d667b9d2545032f4ad29747f51e7ac542e5.png)  
...
![image-20240621090623957.png](images/attach-a37077e342ad04452c72cc21f595599debdf8a4b.png)  
...
![image-20240621090927991.png](images/attach-a5f070a18a244e36ed3308a017cce99a2489fd4d.png)  
...
![image-20240621091014551.png](images/attach-908091e220a7a13845264a83f1c3e957a6dc7db7.png)
...
![image-20240621091142557.png](images/attach-38edb7e7764e4532e3fbffecf12def139d8c520d.png)  
...
![image-20240621091236527.png](images/attach-e6e21d1957e21ce593fdf16ef3a5fe7ad7985245.png)

执行后如下所示

![image-20240621091258723.png](images/attach-4d9fd9838ac877ac13b4eb4516bb371087f6bb11.png)  
以上是伪造的视频，再来看看真实的视频

![image-20240621091356682.png](images/attach-e28f3f8438f19df981599d4d40541f835fc4a41b.png)  
执行后如下所示

![image-20240621091417585.png](images/attach-83d1e8e22c03d7488794a98492bcbd06195722da.png)  
以上就是真实的视频
...
![image-20240621091626430.png](images/attach-3a217a7216bde442c9772154398944f9bf98c0ac.png)

从测试集（`TEST_FOLDER`）中选取一个特定的视频文件，然后从这个视频中捕获一帧图像，并在matplotlib图中显示该图像

![image-20240621091717854.png](images/attach-8970cf32bbfa2e0b554e2a9f0ef7c26d264caf73.png)  
...
![image-20240621091821300.png](images/attach-270c30aeabc16a7ca03a6923788c71c16670d3d5.png)
...
![image-20240621092511344.png](images/attach-023baeb476979a564b30382bae211cd25f6871b6.png)  
接着训练分类器
...
![image.png](images/attach-117a6a7c9542a686c609a8e8bc8a0115b28d2d3b.png)  
...
![image-20240621092726944.png](images/attach-30c8cca3b17b4236859ec7f45135d1358974a9be.png)  
...
![image-20240621092807998.png](images/attach-a52d41873400323df46032beb8d94f6b8c9ab6c5.png)  
