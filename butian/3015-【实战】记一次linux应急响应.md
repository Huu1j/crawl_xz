...
> **来源**: https://forum.butian.net/share/3015  
> **文章ID**: 3015
...
![image.png](images/attach-09fad1400d0378a63d5ca9d4595ff729d8d1d887.png)

查看管理设备2023年x月x号就出现服务器超负荷运行，至今已经8个多月。

![image.png](images/attach-41580eb237afa37c8d0fd5dd484f0dae7f7e396e.png)

查看PID对应的进程  
命令：  
查看进程 ps -aux

![image.png](images/attach-3dece771529437c79697760fe3bb17c3dd335519.png)

2\. 进入对应的PID查看具体路径信息  
命令：  
查看具体的PID信息： ps -aux | grep PID

![image.png](images/attach-b4e9c335bdefa0913a6010a460441f93febfedfb.png)

![image.png](images/attach-34ba46984d0fd26232ef77152c53894926255108.png)

拷贝文件，本地分析 MD5：4499165a5b0f7ac6ddf9dcbbe1f5a4f1  
这里说明一下，不是非要用腾讯，类似还有很多，比如：微步，腾讯等等吧。

![image.png](images/attach-4b6794901e1f0b906527bb5af8694916cbb72a6b.png)  
在微步进行进一步核实

![image.png](images/attach-1f98e9c628661e905970a81486adf67fb255c0ba.png)

![image.png](images/attach-a0f4a1bc7391f244b458b4bea191ce7003e5b14a.png)

确认为恶意远控文件，然后进行查杀进程和查杀文件，发现无法直接查杀，查杀进程后会立即重启该服务进程，且会一直存在。这个时候就有点小麻烦了。不是正常的操作，且隐藏的守护进程不好找。

![image.png](images/attach-02e205d62d54df82d7c1e04e53a6efdd83bf697a.png)
...
下面我们继续寻找守护进程  
进一步排查，计划任务没有  
![image.png](images/attach-52f1b0e8dda9e2c74acaad1c8cd943d8820c1333.png)

排查运行的服务中发现所有者为1001的还有一处服务指向crun.service文件，时间为2022年，比较可疑。

![e97e6a30749d9d6544074ce0fafefc5.png](images/attach-16388a80c5f0e98a7a9ab108ce2808de769e3186.png)  
![image.png](images/attach-edc8c808595552a7f55fdfb90961cdcfd3bcd809.png)

查看最早日期为23年9月7号就已经存在服务器中

![image.png](images/attach-46b88b3cc48bdc1cfdc98f604e9c8bd2c6a9f667.png)

打开crun.service

![image.png](images/attach-8fdf8baee1f44d9261554af9b511425a2e58d5fd.png)
...
![image.png](images/attach-eff382687b7b986840de1339b73cd029f4af7277.png)
