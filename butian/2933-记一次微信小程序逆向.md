...
> **来源**: https://forum.butian.net/share/2933  
> **文章ID**: 2933
...
![image.png](images/attach-88fa2292a9bbe5b8ddf2fc8cb1d19baa68826a8a.png)
...
![image.png](images/attach-14f83292288e618b78d143886bad7a80398452fb.png)
...
![image.png](images/attach-c3c98a4b62a582bb1ab2f50e3fb77793e6fa9b54.png)

AES加密，CBC模式，key和偏移量都拿到了

![image.png](images/attach-757a8f052a7d322b727781936452eb31de083a57.png)
...
![image.png](images/attach-3b03b0633c7d160143253e48993e3ff17d957bfd.png)
...
![image.png](images/attach-3ba4b5b0681e1366bbf2bb8ebb74e7ac0a4926bd.png)

继续查看源码  
找到一处signMD5的调用，应该是md5的计算

![image.png](images/attach-8dce7fa5e2bf9c13fa4a8c2ece0e9f48da8fcd3b.png)

找到i的实现

![image.png](images/attach-1b036363c80ce1b8ffc1a2da55b6e4932232eb23.png)

全局搜索90c5

![image.png](images/attach-fe177fcff67141f21fc882e0fdbf022af3ad0ce0.png)
...
![image.png](images/attach-91471ec4c0398c2d566b722b12d26ecc62a22aba.png)
...
![image.png](images/attach-1c672b6acb40471c357bbda43870c2719b3b6953.png)

最终把这些整合实现重放

![image.png](images/attach-fe46d58c61ee4a36c69220226a7834e43d121548.png)
...
![image.png](images/attach-0416729eda593997ce582126ee7e81973d7b4e84.png)

![image.png](images/attach-921d7ff9e93f594f861e71179877d9c30bbdf3ff.png)

配置好后抓包，效果如下

原来：

![image.png](images/attach-28cde87c7335a0d4b579223fdfdb8c0d246c9755.png)

然后：

![image.png](images/attach-f7b67954bd40b7e9c4a5bf421385eb133bb06c71.png)  
针不戳
...
![image.png](images/attach-506c388a9d81a76b9c715bb9c194ad7c91adebcc.png)
...
这是请求包解密的数据，然后请求  
![image.png](images/attach-3262d4e64ac6c96e7a65364f45e47505265999e6.png)

这个接口就返回大量数据，解密后就是学生数据了  
![image.png](images/attach-937fbc34c74bc2840c31852b32846a75b1831c0f.png)

aes解密后，响应包的大概数据如下

![image.png](images/attach-67b6d2ff4f46df5c9c023f7da434229020940a54.png)
