...
> **来源**: https://forum.butian.net/share/2873  
> **文章ID**: 2873
...
![image](images/attach-df623f8f4424f53a875b05ad45e5909cf28ff921.png)​​
...
![image](images/attach-223e84f0506f8eff6baa68c941a86c18d31a450a.png)​​
...
![image](images/attach-b718585d8d3f1d89f0cdb1712cd99693e21886f6.png)​

所以调用的接口如下

![image](images/attach-0ee2fe8ddad5dfabdb84a4251136d847cfd72fb6.png)​
...
![image](images/attach-624cb821dc15bf124befc34d6300b7d7274741e1.png)​

步进一下进入check函数存在检查文件类型

![image](images/attach-213893c9e8f0371a14acc78b79c65712f05b983d.png)​
...
![image](images/attach-c1a5a3118a8f4c9dc8d21f2acc07372f231532ae.png)​​

在这进行反向验证，讲前面的属性修改为在config里头的内容

![image](images/attach-aae7f3cde3966293bff723cfe380991c16642e30.png)​

再次进行断点跟到最后面的config的地方发现成功修改

![image](images/attach-7f71411015daaafe0f3dfd64e15686d209a3c73c.png)​

所以这套系统只要存在 `$upload->exts =`​ 这个的上传接口 就存在任意文件上传

![image](images/attach-d9a73fbd85e8f38ccee2876d43119c8655ebadd9.png)​
...
![image](images/attach-897b76bd63441fa7eb2958ef5cedf4a1e7b06051.png)​
...
![image](images/attach-a1c2ed262185564813514264114fb8b5f60558ce.png)​
...
![image](images/attach-c2517f108b261ab94704b8b55a8a6e1ecd68b597.png)​
...
![image](images/attach-c62b0b98abd7c026087910f9dc5bf3ad5bf507eb.png)​​
...
![image](images/attach-852291df4b3368fb396c2a8578bb4d53e46583a3.png)​​
