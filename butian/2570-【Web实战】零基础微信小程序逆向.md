...
![微信图片_20231113203305.png](images/attach-f73ae8df70f7fc91637fa84d6d09a8af8a5a037f.png)
...
![123.png](images/attach-00a860379261343605bfb0abb2bf9ed72a3d0e6d.png)
...
![微信图片编辑_20231113170904.jpg](images/attach-a6a5be561b28898be07d2341994f761b3e2e391c.jpg)
...
![image-20231101194645281.png](images/attach-cd7167799097152e650cb043225415dc4cf025dd.png)

![image-20231101194314642.png](images/attach-e70861b8b6a9eb55fc41bd0c2bafed057e90013f.png)
...
![image-20231031200244353.png](images/attach-b91992d89e6d9a3d028257866dba60f6f2a8766a.png)
...
![image-20231031200736105.png](images/attach-15dd43af44e95d067152101bf6372221877d37e0.png)
...
![image-20231102210528302.png](images/attach-178268256295018d3893206578d5063a63d12beb.png)

这里使用的解密工具为代码果所编写UnpackMiniApp.exe，用法为点击“选择加密小程序包”，选中待解密的`__APP__.wxapkg`，将会在UnpackMiniApp.exe当前目录的wxpack文件夹中生成解密后的文件。

![image-20231102210932067.png](images/attach-b59b50415b83b8ec22efc14166cb8e9d3192319e.png)

**注意：一定要选择微信小程序原始位置，移动待测试的`__APP__.wxapkg`文件将会导致无法识别APPID，导致解密失败！**

![image-20231102211503178.png](images/attach-cd59706b876bf871999f20af593567051b7b44e2.png)
...
![image-20231103165358952.png](images/attach-27af5ddd727fe5ec8978d0f0fe08a91b4ac47191.png)
...
![微信图片编辑_20231113172959.jpg](images/attach-f8f745100f69cd3ad9f5af906c0a9f6a09c8e100.jpg)

##### 数据段

数据段为存储的文件内容，可通过索引段的信息进行一一对应。

![image-20231106220830653.png](images/attach-ebe0ab7eef4d270231a9fd0b2934a2cd770ba5b1.png)

#### 小程序反编译

通过索引段与数据段，我们已经可以还原出一个大体的文件结构

![image-20231106222953824.png](images/attach-7ea9fade6412af9a0f292193b22ba0a5adfb0647.png)
...
![image-20231114144736188.png](images/attach-0afd6ba6043b800aa67f1e4d23180fb1ca55ca23.png)

![image-20231114144847288.png](images/attach-9945d500c2eac26bbcab5657a6705900538a97cf.png)
...
![image-20231108200058912.png](images/attach-8b060f0a92b729f8981df3ec46f5b5b458944140.png)
...
![image-20231114185735148.png](images/attach-ac0b28db7de850434e4b8da0ad3aa220d586f56d.png)

添加规则：程序“wechatappex.exe”，动作为刚才设置的代理服务器

![image-20231114185941160.png](images/attach-d4576e830aa32f5348721dc61f0b7c74dcd1dbe9.png)

**BurpSuite配置：**

配置代理服务器，端口为刚才设置的自定义端口，地址为127.0.0.1

![image-20231114190243666.png](images/attach-da247f6281971def431f58c3fef1aa015bd12b1f.png)

通过对小程序功能点进行SQL注入测试，成功返回数据库用户名。

![image-20231114194754553.png](images/attach-df1e0b35f536c0ce505c79225c3a4acb5cac711a.png)
...
![image-20231114202551000.png](images/attach-ab00a0b210b5eecdb6adb766028662506cd7b886.png)

![image-20231114202722415.png](images/attach-1baac368d56603a5139bf79a7d70b2989b5560e8.png)

使用用户名:admin 密码：123456 成功登陆后台，获取大量信息。

![image-20231114203511720.png](images/attach-63df8b120f3ba2bb9f096acffd7bac663973b561.png)
