...
> **来源**: https://forum.butian.net/share/2646  
> **文章ID**: 2646
...
![image.png](images/attach-74973f52b5dfe9a206693c2cefca8b3cdcc23481.png)

另外，由于该补丁作用于WordPad程序，可得该漏洞的触发点可能与RTF文件的格式有关，思路有了就开始进行技术分析。

打补丁之前的MD5:bd05d1b9fba2f5f\*\*b6fbb59d3a78d84

![image.png](images/attach-0237dcdb7a753c7025319dc8f1b88e64a46e2d9d.png)

打补丁之后的MD5:e46d2a1e4836b\*\*d00eeccc0e1db0f52

![image.png](images/attach-905dda18ed00df8c3990f9859f1a3c6c1cb9a293.png)

![image.png](images/attach-d272dc3956e233bc31e01d64bd4a2adedca36cbe.png)

通过IDA Pro + BinDiff的组合可以看到补丁后两者的函数变动，其中一个名叫LoadImageResource的函数引起了注意，和图像交互的地方涉及解析图片，可能会是漏洞的锚点。

![image.png](images/attach-d1d2f4416c0064f267a04812d3cdc6e65e1fa87f.png)
...
![image.png](images/attach-2e0ff1a1d42f562d988e47b96b7bb91a8f22206e.png)

![image.png](images/attach-5bd26637dd7cc2afa617a275501d43c60c20b165.png)  
...
![image.png](images/attach-a182228e7ef4a8dd6b943b27b82fdeabe87873b4.png)

而使用二进制编辑器打开测试文件，可以明显地看到有一个\\objdata包含嵌入对象的十六进制数据的标记。

![image.png](images/attach-fb7e8aea78686d333d578094342a6ae3bb7d3483.png)
...
![image.png](images/attach-2a8e02081ffb170483a060dd280d0917ef531f4f.png)
...
![image.png](images/attach-94d614af3109f55642e016a84b27c8752322f845.png)

![image.png](images/attach-c43f9b9e02ca133117144992b5c42561eb1d1302.png)  
![image.png](images/attach-46b0cfc28ed322d85570dbe1b896d19ad2dde376.png)  
...
![image.png](images/attach-11d5939ff700512dc307c35731b8d9463c876aa8.png)
...
![image.png](images/attach-d26e3325e82c9cbe8c79a78585433c21e5c9e827.png)
...
![image.png](images/attach-a5aab02f4fb1ac1f842e98d693c8840d6c20c09a.png)

除了将TopicName设置为SMB目标外，还需要删除NativeDataSize和NativeData的chunk，因为LinkedObject结构不包含它们。

![image.png](images/attach-2a9ad7ee4cf37a9893d3b000502cfd149797b3a2.png)  
...
![image.png](images/attach-6a637463af8db30c68a7fac375c3ea3f26c0bd0f.png)

好消息是，虽然Wordpad弹了个框，不过受害者机器已经向攻击者的服务器发起了NTLM身份验证。

![image.png](images/attach-854e05872bc99bf5b692a28f6503f99208ddbcb0.png)

![image.png](images/attach-a6fbdb4b6dc729482fffcab3c771e726b550e456.png)

![image.png](images/attach-1e240df82caf6dbb13298760ad66a066cbb76891.png)
