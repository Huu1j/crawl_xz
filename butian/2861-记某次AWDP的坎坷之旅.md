...
> **来源**: https://forum.butian.net/share/2861  
> **文章ID**: 2861
...
![image](images/attach-273c3fa7d6f6bbdef804bc9065161e2ec2b0a6ac.png)​

给了两个源码，src应该是源码，packages是依赖

![image](images/attach-a66c77a46ffe690cdcd0289db44662b80de046d5.png)​

这里还是很抽象的，他题目说web根目录在/app下，md这源码还有个app...(我写了11个包都是在/app下，我人都傻了，全是exp利用成功，求求你了ichunqiu带点脑子写清楚点会死吗)

![image](images/attach-9ef552f01a205056b529303af228bd1ecb8f6aa5.png)​

当时exp利用成功了11次我就看settings tmd 我还觉得奇怪呢

![image](images/attach-b62aa3bad330387df7e74eff66f85a41628cb4fe.png)​

审计urls.py发现定义了三个路由

![image](images/attach-fbe2c7c7c3c9bfcfd058121df75b48cd6fe61481.png)​
...
![image](images/attach-35836d62645ad84c19bb13ac4bacffa0006cb358.png)​
...
![image](images/attach-803507e866f1888486304dbda29894ddc5a1169f.png)​

啥意思呢，就是他是需要导包的，我们通过不允许他导包来进行测试服务异常，发现在这三个导入的包，只有file会异常，所以异常文件在file目录下的**init**文件

![image](images/attach-7b6f1876747ba1303ed1ec7a29f358e67f61d668.png)​
...
![image](images/attach-64cd7d69fa70fe43ceafba9da3c42c819d3b97ef.png)​​
...
![image](images/attach-aa50b57942b22cf224612c3342daa1050cdc45da.png)​

### Break

依赖就spring的依赖并且版本为2.7.12

![image](images/attach-e87ca1a04393e99e87af74283a873b8cc8a32491.png)​

![image](images/attach-3afd4ba64a6fc2f54c23a097f7442b4dc85995e6.png)​

‍

看对应路由，就一个

![image](images/attach-5ccee247ce51334355ddce59fb96c01c3cca36d6.png)​
...
![image](images/attach-8cea398773f07ed5d79e16ea08e52eb7c1cac7c3.png)​
...
![image](images/attach-ea9c1c81779f0aa34d2dfa2b16588b8e553c153c.png)​
...
![](images/attach-371fca7943714836fc23ad5f68cb0103343c5066.png)
...
![image](images/attach-e2faab3986f1fff7136d60f0c550adf3de2ce18a.png)​
...
![image](images/attach-12c8a7de6635a2d3721de3ea3df0762eb9869413.png)​
...
![image](images/attach-11edd7d55e3d3ddbe7772f42983aac93598af192.png)​

而这个`treeMap`​是通过`SecurityCheck`​的构造方法进行了赋值的

![image](images/attach-26b679a0bb55b48cb19ae4b8a9b410ef76d1efe8.png)​

也就是说 `treeMap`​其实是一个存储着序列化的base64值的`hashset`​

![image](images/attach-35455b660fb98d9720aef037048c471660519ef4.png)​
...
![image](images/attach-5ef5d1e505508efdfc362a7338de7c72433f0a22.png)​
...
![image](images/attach-35d7ed4ff07e1a4c0fa1a1b44d791dc3e471f203.png)​
