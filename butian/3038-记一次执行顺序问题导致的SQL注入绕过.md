...
> **来源**: https://forum.butian.net/share/3038  
> **文章ID**: 3038
...
![image.png](images/attach-66950a634e300215c4dd63f902a7b35eba48d3fa.png)
...
![image.png](images/attach-28e02e6514d1a8ffcd845fb60894e181ec19bdbe.png)
...
![image.png](images/attach-53f2ef7d4e8fb892b8667e9f3d605cd954f15d46.png)
...
![image.png](images/attach-07f36c679c96a660b746642138a553d6d1edc369.png)

 然后遍历所有过滤器映射，根据一定的条件判断将匹配的过滤器添加到过滤器链中。条件包括与调度类型的匹配和与请求路径或Servlet名称的匹配：

![image.png](images/attach-f5c306f73943fe4e0901052ed7a02897259eb7be.png)

 最后，返回创建的过滤器链，该过滤器链包含了所有匹配的过滤器。如果没有找到匹配的过滤器，则返回一个空的过滤器链。创建了filterChain之后，就开始执行ApplicationFilterChain的doFilter进行请求的链式处理：

![image.png](images/attach-152c63768756d01857d7aea7fb882b4584a27397.png)
...
![image.png](images/attach-55647db244322258309ea3125577ee0f7e2d6bc1.png)

 当所有的filter执行完后，会释放掉过滤器链及其相关资源。然后执行servlet具体的业务模块`servlet.service(request, response);`：

![image.png](images/attach-1f98df628120388118ea0c8caffa152757fc0ca1.png)
...
![image.png](images/attach-91b24f2c10c37279e2167f594a04c34235c615ee.png)  
...
![image.png](images/attach-621c18b3e214a0c40c191f12b2e15eee19f78e32.png)

 在getHandler方法中，顺序循环调用HandlerMapping的getHandler方法进行解析：

![image.png](images/attach-41bbcb357b820bd84afca15d7445d01b68e1b864.png)
...
![image.png](images/attach-206cc97e14d841f62973fa99d26ef92439a7f143.png)
...
![image.png](images/attach-182a27dd5040a560a6c618723c3ac1cc1f8f5c9c.png)
...
![image.png](images/attach-c38969f05760ebd539aa7709f2fca806368fb138.png)

 实际就到了执行拦截器前置处理preHandle方法的时候了：

![image.png](images/attach-9c4b69317bad40ec278a2a357f9d7aa289b57cdd.png)
...
![image.png](images/attach-5d97b238b3b327767c2a0f98750ec37828a5ff44.png)
...
![image.png](images/attach-eed55e90b14a0377a333be74727bf995aa65538c.png)
