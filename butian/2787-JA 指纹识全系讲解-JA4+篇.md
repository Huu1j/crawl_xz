...
> **来源**: https://forum.butian.net/share/2787  
> **文章ID**: 2787
...
![](images/attach-86420bf7a273fdce62125efe0476c3e569435f71.png)

启动 WireShark 后还需要在【编辑】—> 【首选项】中进行配置  
![](images/attach-9c30bbabc6f4fcd5855b67ae4e37025c12d1fb88.png)

打开首选项中的【外观】—> 【列】，点击`+`号添加一个新的列，类型选择自定义(Custom)，具体配置可参考官方的配置表  
![](images/attach-92d8180580022466e16fc64b889477fff45c80dc.png)

假设我们这里添加了 JA4 的规则，打开抓包页面后就会出现一条与 JA4 相关的列  
![](images/attach-2fae5ad79ab4e4b6484916e8bfcb0e6ac2e7e899.png)

同时也支持以 JA4 指纹作为过滤器  
![](images/attach-d480b54c2537d7971b93bf75601c92067369ac30.png)

目前 WireShark 最新版已经原生支持 JA4 指纹了，如果对系列中的其他分支无需求就不用做上述额外的配置，同时还发现通过插件实现的 JA4 计算存在无法正确获取版本号的问题，导致计算出的 JA4\_a 不同  
![](images/attach-1b4bdf135764b5c4ba91c4115b3a8bc3c756861d.png)
...
![](images/attach-6877fd32a88d4570f5388d6122d5aab8319d2d8a.png)
...
![](images/attach-6dae90cf6ea65f2aa1fb3520b308bea07397cd76.png)
...
![JA4.png](images/attach-383707f187eb37f9e85ef2643ecc3bd4cd8cb323.png)
...
![](images/attach-3deb8e90483932ed81786f2fbdbad951105c5a4b.png)
...
![](images/attach-d4d12cc2494eb93e1e0dfa280537cfa69c0435be.png)  
出现 TLS Version 的部分一共有三个部分，上面出现 13 的原因就是在拓展（Extension）中有一项`supported_version`存在 TLS 1.3  
![](images/attach-ac422257f78673be0fafb57d24e13710b42bd203.png)  
![](images/attach-f8e3e0511b15cd759ad9c103b32d858cf2c7d254.png)

- `d`：代表 Domain，这里的判断依据是 SNI Extensions，如果它存在则访问的是域名，不存在则说明访问的是 IP，此时为`i`  
    ![](images/attach-acbeff8e2bc5f843a3e0211c8fc3ce296c8ce18e.png)
...
- `h2`：代表 ALPN 值，选取第一个值，更多情况见[官方文档](https://www.iana.org/assignments/tls-extensiontype-values/tls-extensiontype-values.xhtml#alpn-protocol-ids)，若报文中没有此项，则使用`00`  
    ![](images/attach-8febb2e4545362e5bc12c26977d14dffc3bcc819.png)
...
![](images/attach-e6d5e1aa35e7c0cf873d9e4c1f3f86a7a99aa1d2.png)  
![](images/attach-7f0a025fbfed77365bd4c814b59edadab47b712f.png)
...
![](images/attach-c788896cf60058ec54b8b45206a6b8f3e239334d.png)

之后会再读取一个 Extension 中 signature\_algorithms(签名算法) 的值，同样使用`,`作为分隔符  
![](images/attach-174c9e02c3f730291305567a8cf20e536a31c4f2.png)
...
![](images/attach-4e9bde070eb0a634543e764d5f93a508bf3a73eb.png)
...
![](images/attach-9fb1e7ea41870423b9602f825914898802d2d46e.png)
...
![](images/attach-053b89c85ee5b99bcab924b8cb7a0dde6645cf3c.png)  
![](images/attach-c3daf7d9b097fb5d2dd75c32bbc1bca5c576fbea.png)
...
![](images/attach-0e75049bb94f4bf3d6cd7256e9cb3aa8e1272182.png)
...
![](images/attach-c405b8e959fd1d109ed2afeaea94709b6045861b.png)  
![](images/attach-06f802f18cfc5ea059b6d4e7f20268c51a66ff82.png)
...
![](images/attach-ec95e05b9a479d0ce919af80b249d08037ce0642.png)
...
![](images/attach-fac47797361ef94e7cfa460ecdf8ea40929d493e.png)
...
![](images/attach-c7cd68265cea4d92d5a4cd1a18c318cb1e2d7bfe.png)
...
- TCP 流量  
    ...
    ![](images/attach-696338d855e054e2c1dcc4c5ab0b3a96da493d41.png)
...
- UDP 流量（QUIC）  
    ...
    ![](images/attach-4a61d9a351a2c1a79d4f7afcdb7238bcc3628e0f.webp)
...
![](images/attach-f87c97be74cb7816ef47a522bdf081065df31347.webp)
...
![](images/attach-c18dc64b8c52a5d34de6d0aab2ad069a2b49e1ce.png)

### JA4X 计算原理

![](images/attach-1b6b60f60d09d48aa913dda18c5a4c42ecf4f7f6.webp)
...
![](images/attach-3754cd5221f4e46e5825822282677ea1ac083268.png)
...
![](images/attach-c8719b0cb24b6624537d424c9895eddcbf6e04ae.png)
...
![](images/attach-7d12def7587033e23c6f17ece6a4bc57edbff4e1.png)
