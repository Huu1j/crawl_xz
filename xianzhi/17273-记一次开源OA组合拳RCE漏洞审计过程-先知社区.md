# 记一次开源OA组合拳RCE漏洞审计过程-先知社区

> **来源**: https://xz.aliyun.com/news/17273  
> **文章ID**: 17273
...
![image.png](images/d2f03b03-c512-3614-b630-9c23632f9ccf)
...
![image.png](images/44b23c47-beed-3156-9afb-9e641e4865f4)
...
![image.png](images/bc08ca60-6c67-319f-8c1b-d0089bd997b6)
...
![image.png](images/b9cad8d5-c7d2-31d5-abb6-4f5e0ba79898)

![image.png](images/7e7a85c8-27b9-3073-8a8c-2f1805049c17)
...
利用这个函数达到RCE的结果，分成两步，第一步，利用$uarr['id'] = m('file')->insert($uarr);方法，把我们恶意的内容写入到数据库中；第二步。利用$this->rock->createtxt($filepath, file\_get\_contents($lujing));来创建文件。

漏洞复现

本地开启python服务

![image.png](images/06fee050-1745-31b7-861b-ed688c78820e)

打入payload

![image.png](images/a5c08bcf-c3fa-3ad9-93be-90794d95f651)

之后去遍历fileid

![image.png](images/c48fd6f7-cd21-31d9-bfca-ddd97c9ea05d)

![image.png](images/c3be4d56-5b9c-377b-9b15-22754c0ca0fd)
