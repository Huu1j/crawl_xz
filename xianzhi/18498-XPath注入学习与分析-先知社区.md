...
> **来源**: https://xz.aliyun.com/news/18498  
> **文章ID**: 18498
...
![image.png](images/20250804145743-51d00018-7100-1.png)
...
![](images/20260326204620-ca2a928e-2911-1.png)
...
![](images/20260326204621-cab0bf37-2911-1.png)
...
![](images/20260326204622-cb02d642-2911-1.png)

![](images/20260326204622-cb33a33c-2911-1.png)

## Xpath 语法

常用的语法

* `<font style="color:rgb(31, 35, 40);background-color:rgba(129, 139, 152, 0.12);">/</font>` - 选择直接子节点
* `<font style="color:rgb(31, 35, 40);background-color:rgba(129, 139, 152, 0.12);">//</font>` - 选择任意位置的后代节点
* `<font style="color:rgb(31, 35, 40);background-color:rgba(129, 139, 152, 0.12);">@</font>` - 选择属性
* `<font style="color:rgb(31, 35, 40);background-color:rgba(129, 139, 152, 0.12);">[]</font>` - 谓语，用于筛选条件
...
![image.png](images/20250804145744-522328e8-7100-1.png)

### 节点遍历技术

可以当做我们在不清楚 XML 结构时的典型探测手段
