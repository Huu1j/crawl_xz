...
> **来源**: https://xz.aliyun.com/news/18786  
> **文章ID**: 18786
...
![图片.png](images/img_18786_000.png)
...
看到`WEB-INF/web.xml`  
![图片.png](images/img_18786_001.png)

存在ImgController这个servlet，跟进一下  
![98efac1b41914a8abb399f642f93ac3c.png](images/img_18786_002.png)

是一个很简单的传参，然后调用`com.metasoft.wxsconf.wxdb.accountdb.AccountPO#getAc`  
![图片.png](images/img_18786_003.png)
...
![图片.png](images/img_18786_004.png)

### /business/common/toviewspecial.jsp文件读取

也是一个很简单的洞，看到toviewspecial.jsp  
![94e256a605fc4934bfd7d5947b4e01ea.png](images/img_18786_005.png)
...
![图片.png](images/img_18786_006.png)

可惜只能包含Tomcat目录下文件，无法穿越到系统根目录，比较鸡肋

### /business/common/download-new.jsp文件读取

![f21547bfc33048c29ec7103727020bb8.png](images/img_18786_007.png)
...
![图片.png](images/img_18786_008.png)

### /services/ws XXE

看到`WEB-INF/web.xml`  
![图片.png](images/img_18786_009.png)

存在CXFServlet，访问即可看到  
![图片.png](images/img_18786_010.png)

跟进到`com.metasoft.ws.service.data.CommonOperationServImpl`，先看到commonCheckServ  
![4601b0dd5bf449deb7ef9859877e047c.png](images/img_18786_011.png)

发现使用的`DocumentUtil.getDocument4String`处理数据  
![图片.png](images/img_18786_012.png)
...
DNSLog成功收到请求  
![图片.png](images/img_18786_013.png)

同理其余几个方法都存在该漏洞  
往后看了下，还存在sql注入  
![de45705d23e94625aff66e2a56c67ddb.png](images/img_18786_014.png)
...
![fd5bc79f1271466c873f29094581e7a9.png](images/img_18786_015.png)

获取传参p赋值给downUrl，然后获取文件名、文件、类型，注意这里不能超时

主要是`new AnalyzeParam(downUrl)`，跟进一下  
![图片.png](images/img_18786_016.png)
...
全局搜索upload，还是能找到其他上传方法的，看到`/develop/systparam/softlogo/upload.jsp`![e2c09d6421b646c4914c002a96b48f12.png](images/img_18786_022.png)

首先就是一个鉴权，所以这是一个后台漏洞  
![ad4530a1d4ff47b6bc0f7e35972d9faf.png](images/img_18786_023.png)
...
![图片.png](images/img_18786_024.png)

这里测试一下  
![图片.png](images/img_18786_025.png)
