...
> **来源**: https://xz.aliyun.com/news/16395  
> **文章ID**: 16395
...
![](images/20241231113034-982a3622-c727-1.png)
...
![](images/20241231113034-98893c9e-c727-1.png)

目录：

![](images/20241231113035-98c47d0c-c727-1.png)
...
![](images/20241231113035-990fef28-c727-1.png)

maven：

![](images/20241231113036-995e8d22-c727-1.png)

按照文1写入类内容

![](images/20241231113036-99aa3ccc-c727-1.png)

## RASP初了解

ASM中不同类不同方法的关系图如下：

![](images/20241231113037-9a43b4d8-c727-1.png)
...
![](images/20241231113038-9aba3a74-c727-1.jpg)

配个Tomcat的cmd.jsp：

模块里新建个web模块

![](images/20241231113038-9b006c74-c727-1.png)

![](images/20241231113039-9b3c51d8-c727-1.png)

新建一个展开型Web工件，把刚才创建的Web模块搞进去

![](images/20241231113039-9b78e22e-c727-1.png)

![](images/20241231113040-9bbd39b0-c727-1.png)

Tomcat部署

![](images/20241231113040-9bf652c2-c727-1.png)

目录里现在有了web目录

![](images/20241231113041-9c363702-c727-1.png)
...
![](images/20241231113041-9c765530-c727-1.png)

访问`http://localhost:8080/agent_Web_exploded/cmd.jsp?cmd=whoami`后，控制台执行打印加载流程和执行结果

![](images/20241231113041-9c98fcfa-c727-1.png)

![](images/20241231113042-9cd7fd76-c727-1.png)
...
![](images/20241231113042-9d051fb8-c727-1.png)
...
![](images/20241231113042-9d314b7e-c727-1.png)
...
![](images/20241231113042-9d565022-c727-1.png)

![](images/20241231113043-9d81fba8-c727-1.png)
...
![](images/20241231113043-9ddb88e6-c727-1.png)
...
![](images/20241231113044-9e2826ba-c727-1.png)
...
![](images/20241231113044-9e8b9198-c727-1.png)
...
![](images/20241231113045-9ec0779e-c727-1.png)

![](images/20241231113045-9eebbb28-c727-1.png)

![](images/20241231113045-9f126f2c-c727-1.png)

从上面的时序图可以看出修改字节码的顺序，具体代码在ClassReader，太复杂了懒得看。

![](images/20241231113046-9f512ecc-c727-1.png)
...
![](images/20241231113046-9f853c28-c727-1.png)

方法内定义的局部变量也会按顺序存储在局部变量表中

![](images/20241231113046-9fb8a298-c727-1.png)
...
![](images/20241231113047-9fe9e524-c727-1.png)

maven打包后重新加个JAR应用程序配置，虚拟机选项依旧得填上

![](images/20241231113047-a02a127a-c727-1.png)

MANIFEST.MF加上主类`Main-Class: cn.org.javaweb.agent.MainTest`

![](images/20241231113047-a05496da-c727-1.png)
...
![](images/20241231113048-a07b3ac6-c727-1.png)

org.mvel2.MVEL.eval同理

![](images/20241231113048-a0aabd62-c727-1.png)

> 更深思考一步，假如我监测的是MVELInterpretedRuntime，需要压栈哪个变量才能获取表达式字符串？
>
> ![](images/20241231113048-a0eb90e4-c727-1.png)
>
> 继承的AbstractParser如下：
>
> ![](images/20241231113049-a11e49e4-c727-1.png)
>
...
![](images/20241231113049-a153a094-c727-1.png)

### agentmain

上述demo需要在虚拟机选项，也就是启动参数加上-javaagent，而且每次修改都需要重新打包启动

![](images/20241231113050-a19c5622-c727-1.png)
...
![](images/20241231113050-a1c3d9b8-c727-1.png)
...
![](images/20241231113050-a1eb671c-c727-1.png)
...
![](images/20241231113050-a221bd62-c727-1.png)

![](images/20241231113051-a256e050-c727-1.png)
...
![](images/20241231113051-a27b5ea8-c727-1.png)

直到你的依赖项：

![](images/20241231113051-a2b0ea14-c727-1.png)

下面是个演示：

![](images/20241231113052-a311a23a-c727-1.gif)

我们再次思考"重新"attach的含义，是不是可以重复地attach同一个程序？

答案是对的，下面是attach两次MainTest的结果，可以看到CALL了两次

![](images/20241231113053-a391ab8a-c727-1.png)

## question

现在让我们解答case2中提出的问题，为什么会打印命令的所有调用链？

![](images/20241231113053-a3d36374-c727-1.png)
...
但是agentmain不行。从字节码和代码逻辑上来说，利用ASM ACC\_PUBLIC可以新建一个public方法
...
![](images/20241231113054-a40569f8-c727-1.png)

## 总结

以下均来自Lucifaer作者的思考<https://paper.seebug.org/1041/>
...
![](images/20241231113054-a430c58a-c727-1.png)
