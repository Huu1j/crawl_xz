...
![图片.png](images/img_18008_000.png)跟进看一下findSerializerFactory的具体内容：

![图片.png](images/img_18008_001.png)
...
猜测两者功能相同（或是至少是相互配合的），在getDeserializer(String type)处打一个断点调试一下：![图片.png](images/img_18008_002.png)可以看到此时的type就是反序列化时用到了类名。
...
![图片.png](images/img_18008_003.png)那么我们就可以通过创建一个Hashset的BLACKLISTED\_CLASSES，然后向其中添加黑名单来进行防御了。
