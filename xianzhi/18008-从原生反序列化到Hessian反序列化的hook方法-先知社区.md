...
![图片.png](images/80e519ef-26ea-3e94-8ee6-a3497362c9db)
...
猜测两者功能相同（或是至少是相互配合的），在getDeserializer(String type)处打一个断点调试一下：

![图片.png](images/794fe582-eb9f-32d8-982c-1c14675dab52)

可以看到此时的type就是反序列化时用到了类名。  
...
![图片.png](images/045fc727-7a21-32c7-97d1-a411c7184ba0)
