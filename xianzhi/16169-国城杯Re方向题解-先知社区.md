...
> **来源**: https://xz.aliyun.com/news/16169  
> **文章ID**: 16169
...
主要需要注意的在 `int i6 = i5 != 1 ? i5 == 2 ? 1 : i5 : 2;`
...
发现是单字符加密，直接爆破：  
这里直接用frida，但其实可以直接复制代码到Java跑的。  
由于单字符加密结果可能存在多个，这里用了DFS来找。
...
根据wp提示，知道是魔方。  
先来个魔方的图：  
![](images/20241213170155-e6fd3eb6-b930-1.png)  
...
* 之后走迷宫就很好理解了
  ...
  ![](images/20241213170214-f1edfc16-b930-1.png)  
  网上求解：  
  ![](images/20241213170222-f6c1a314-b930-1.png)  
  输入`UUDDRRLLFFBB`，即可得到maze（起点`(11,1)`，终点`(13,31)`）  
  ![](images/20241213170229-fb613560-b930-1.png)  
  ...
  ![](images/20241213174551-09d21dd4-b937-1.png)
