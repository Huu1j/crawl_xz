...
抓一个登录请求包分析  
![image.png](images/img_18185_000.png)
...
![image.png](images/img_18185_001.png)

![image.png](images/img_18185_002.png)
...
![image.png](images/img_18185_003.png)
...
![image.png](images/img_18185_004.png)

看getpostarr()方法可以分析出 传入的post值需要为json格式  
![image.png](images/img_18185_005.png)
...
![image.png](images/img_18185_006.png)

继续分析代码 查看querydata方法获得了三个参数做了什么操作 看代码发现 在方法中将传入的 $modenum 也就是 $num 传入了initflow方法中  
![image.png](images/img_18185_007.png)

![image.png](images/img_18185_008.png)

继续跟进initflow方法 发现又被传入了initdata 方法中

![image.png](images/img_18185_009.png)

在这里 $num 的值被添加到了sql的一个条件语句中被执行 其中无任何限制 这样我们就可以开始构造poc 进行利用  
![image.png](images/img_18185_010.png)
...
![image.png](images/img_18185_011.png)

![image.png](images/img_18185_012.png)
